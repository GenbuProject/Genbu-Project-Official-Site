...
function TMTInit() {
	for (let i = 0; i < File.length; i++) {
		switch (File[i].attributes["Type"].value.toLowerCase()) {
			case "text":
				File[i].innerHTML = '<Img Src = "https://genbuproject.github.io/Genbu-Project-Official-Site/Too%20Many%20Tags/File/File-Text.Svg" Width = "' + WIDTH + '" Width = "' + WIDTH + '" Height = "' + HEIGHT + '">' + ' ' + File[i].innerHTML;
				break;
				
			case "image":
				File[i].innerHTML = '<Img Src = "https://genbuproject.github.io/Genbu-Project-Official-Site/Too%20Many%20Tags/File/File-Image.Svg" Width = "' + WIDTH + '" Height = "' + HEIGHT + '">' + ' ' + File[i].innerHTML;
				break;
				
			case "music":
				File[i].innerHTML = '<Img Src = "https://genbuproject.github.io/Genbu-Project-Official-Site/Too%20Many%20Tags/File/File-Music.Svg" Width = "' + WIDTH + '" Height = "' + HEIGHT + '">' + ' ' + File[i].innerHTML;
				break;
				
			case "video":
				File[i].innerHTML = '<Img Src = "https://genbuproject.github.io/Genbu-Project-Official-Site/Too%20Many%20Tags/File/File-Video.Svg" Width = "' + WIDTH + '" Height = "' + HEIGHT + '">' + ' ' + File[i].innerHTML;
				break;
				
			case "zip":
				File[i].innerHTML = '<Img Src = "https://genbuproject.github.io/Genbu-Project-Official-Site/Too%20Many%20Tags/File/File-Zip.Svg" Width = "' + WIDTH + '" Height = "' + HEIGHT + '">' + ' ' + File[i].innerHTML;
				break;
				
			case "other":
			default:
				File[i].innerHTML = '<Img Src = "https://genbuproject.github.io/Genbu-Project-Official-Site/Too%20Many%20Tags/File/File-Other.Svg" Width = "' + WIDTH + '" Height = "' + HEIGHT + '">' + ' ' + File[i].innerHTML;
				break;
		}
	}
	...
	for (let i = 0; i < Folder.length; i++) {
		if (Folder[i].attributes["Type"] != undefined) {
			switch (Folder[i].attributes["Type"].value.toLowerCase()) {
				case "drive":
					Folder[i].innerHTML = '<Img Src = "https://genbuproject.github.io/Genbu-Project-Official-Site/Too%20Many%20Tags/Folder/Folder-Drive.Svg" Width = "' + WIDTH + '" Height = "' + HEIGHT + '">' + ' ' + Folder[i].innerHTML;
					break;
					
				case "directory":
				default:
					Folder[i].innerHTML = '<Img Src = "https://genbuproject.github.io/Genbu-Project-Official-Site/Too%20Many%20Tags/Folder/Folder-Normal.Svg" Width = "' + WIDTH + '" Height = "' + HEIGHT + '">' + ' ' + Folder[i].innerHTML;
					break;
			}
		} else {
			Folder[i].innerHTML = '<Img Src = "https://genbuproject.github.io/Genbu-Project-Official-Site/Too%20Many%20Tags/Folder/Folder-Normal.Svg" Width = "' + WIDTH + '" Height = "' + HEIGHT + '">' + ' ' + Folder[i].innerHTML;
