package com.microsoft.onlineid.interop.xbox.model.serialization;
...
public class UTCDateConverter
{
  ...
  public static Date convert(String paramString)
  {
    ...
    //   96: iload_1
    //   97: ifeq +88 -> 185
    //   100: getstatic 52	com/microsoft/onlineid/interop/xbox/model/serialization/UTCDateConverter:defaultFormatNoMs	Ljava/text/SimpleDateFormat;
    //   103: aload 4
    //   105: invokevirtual 114	java/text/SimpleDateFormat:setTimeZone	(Ljava/util/TimeZone;)V
    //   108: getstatic 52	com/microsoft/onlineid/interop/xbox/model/serialization/UTCDateConverter:defaultFormatNoMs	Ljava/text/SimpleDateFormat;
    //   111: aload_0
    ...
    //   181: istore_1
    //   182: goto -100 -> 82
    //   185: getstatic 56	com/microsoft/onlineid/interop/xbox/model/serialization/UTCDateConverter:defaultFormatMs	Ljava/text/SimpleDateFormat;
    //   188: aload 4
    //   190: invokevirtual 114	java/text/SimpleDateFormat:setTimeZone	(Ljava/util/TimeZone;)V
    //   193: getstatic 56	com/microsoft/onlineid/interop/xbox/model/serialization/UTCDateConverter:defaultFormatMs	Ljava/text/SimpleDateFormat;
    //   196: aload_0
    //   197: invokevirtual 117	java/text/SimpleDateFormat:parse	(Ljava/lang/String;)Ljava/util/Date;
    //   200: astore_0
    //   201: goto -183 -> 18
    //   204: astore_0
    //   205: getstatic 36	com/microsoft/onlineid/interop/xbox/model/serialization/UTCDateConverter:TAG	Ljava/lang/String;
    //   208: aload_0
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\MCPE.jar!\com\microsoft\onlineid\interop\xbox\model\serialization\UTCDateConverter.class
