  ...
  extends NativeActivity
{
  ...
  private void initAtlasMeta()
  {
    ...
    try
    {
      AtlasProvider localAtlasProvider1 = new AtlasProvider("images/terrain.meta", "images/terrain-atlas.tga", "images/terrain-atlas/", new TGAImageLoader(), 1, 4, false);
      AtlasProvider localAtlasProvider2 = new AtlasProvider("images/items.meta", "images/items-opaque.tga", "images/items-opaque/", new TGAImageLoader(), 2, 0, true);
      ...
      ScriptManager.terrainMeta = localAtlasProvider1.metaObj;
      ScriptManager.itemsMeta = localAtlasProvider2.metaObj;
      return;
    }
    catch (Exception localException)
    {
  ...
  private boolean isAddonCompat(String paramString)
  {
    ...
    } while ((!this.mcPkgInfo.versionName.startsWith("0.15")) || (!paramString.startsWith("0.15.0")));
    return true;
  }
  ...
  public int[] getImageData(String paramString, boolean paramBoolean)
  {
    ...
    try
    {
      for (InputStream localInputStream = getInputStreamForAsset(paramString); localInputStream == null; localInputStream = getRegularInputStream(paramString)) {
  ...
  {
    return this.mcPkgInfo.versionName.startsWith("0.14");
  }
  ...
  protected void loadNativeAddons()
  {
    ...
    this.addonOverrideTexturePackInstance = new AddonOverrideTexturePack(this);
  ...
  {
    // Byte code:
    //   0: new 2076	java/lang/ref/WeakReference
    //   3: dup
    //   4: aload_0
    //   5: invokespecial 2078	java/lang/ref/WeakReference:<init>	(Ljava/lang/Object;)V
    ...
    //   41: iload_3
    //   42: invokevirtual 1108	java/lang/StringBuilder:append	(I)Ljava/lang/StringBuilder;
    //   45: invokevirtual 557	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   48: invokevirtual 985	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   51: iload_3
    //   52: istore_2
    //   53: iload_3
    //   54: iconst_2
    ...
    //   103: invokeinterface 1092 1 0
    //   108: pop
    //   109: aload_0
    //   110: invokevirtual 2086	com/mojang/minecraftpe/MainActivity:getApplicationContext	()Landroid/content/Context;
    //   113: putstatic 2089	net/zhuoweizhang/mcpelauncher/MinecraftVersion:context	Landroid/content/Context;
    //   116: iconst_0
    //   117: istore_3
    //   118: aload_0
    //   119: aload_0
    ...
    //   141: putfield 963	com/mojang/minecraftpe/MainActivity:mcAppInfo	Landroid/content/pm/ApplicationInfo;
    //   144: aload_0
    //   145: getfield 963	com/mojang/minecraftpe/MainActivity:mcAppInfo	Landroid/content/pm/ApplicationInfo;
    ...
    //   204: invokevirtual 985	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   207: aload_0
    //   208: invokespecial 2095	com/mojang/minecraftpe/MainActivity:checkArch	()V
    //   211: aload_0
    //   212: getfield 963	com/mojang/minecraftpe/MainActivity:mcAppInfo	Landroid/content/pm/ApplicationInfo;
    //   215: getfield 2098	android/content/pm/ApplicationInfo:sourceDir	Ljava/lang/String;
    //   218: aload_0
    //   219: getfield 963	com/mojang/minecraftpe/MainActivity:mcAppInfo	Landroid/content/pm/ApplicationInfo;
    //   222: getfield 2101	android/content/pm/ApplicationInfo:publicSourceDir	Ljava/lang/String;
    ...
    //   249: aload_0
    //   250: iload 4
    //   252: invokestatic 2105	net/zhuoweizhang/mcpelauncher/MinecraftVersion:getRaw	(I)Lnet/zhuoweizhang/mcpelauncher/MinecraftVersion;
    //   255: putfield 1014	com/mojang/minecraftpe/MainActivity:minecraftVersion	Lnet/zhuoweizhang/mcpelauncher/MinecraftVersion;
    //   258: aload_0
    //   259: getfield 1014	com/mojang/minecraftpe/MainActivity:minecraftVersion	Lnet/zhuoweizhang/mcpelauncher/MinecraftVersion;
    //   262: ifnonnull +21 -> 283
    //   265: iconst_1
    //   266: putstatic 268	com/mojang/minecraftpe/MainActivity:tempSafeMode	Z
    //   269: aload_0
    //   270: sipush 4100
    //   273: invokevirtual 1033	com/mojang/minecraftpe/MainActivity:showDialog	(I)V
    //   276: aload_0
    //   277: invokestatic 2109	net/zhuoweizhang/mcpelauncher/MinecraftVersion:getDefault	()Lnet/zhuoweizhang/mcpelauncher/MinecraftVersion;
    //   280: putfield 1014	com/mojang/minecraftpe/MainActivity:minecraftVersion	Lnet/zhuoweizhang/mcpelauncher/MinecraftVersion;
    //   283: aload_0
    //   284: getfield 1014	com/mojang/minecraftpe/MainActivity:minecraftVersion	Lnet/zhuoweizhang/mcpelauncher/MinecraftVersion;
    //   287: getfield 2112	net/zhuoweizhang/mcpelauncher/MinecraftVersion:needsWarning	Z
    //   290: ifeq +12 -> 302
    //   293: ldc -103
    //   295: ldc_w 2114
    //   298: invokestatic 2117	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   301: pop
    //   302: aload_0
    //   303: getfield 1014	com/mojang/minecraftpe/MainActivity:minecraftVersion	Lnet/zhuoweizhang/mcpelauncher/MinecraftVersion;
    //   306: putstatic 2118	net/zhuoweizhang/mcpelauncher/patch/PatchUtils:minecraftVersion	Lnet/zhuoweizhang/mcpelauncher/MinecraftVersion;
    //   309: aload_0
    //   310: getfield 336	com/mojang/minecraftpe/MainActivity:mcPkgInfo	Landroid/content/pm/PackageInfo;
    //   313: getfield 885	android/content/pm/PackageInfo:versionName	Ljava/lang/String;
    //   316: ldc_w 904
    //   319: invokevirtual 888	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   322: ifne +938 -> 1260
    //   325: aload_0
    //   326: getfield 336	com/mojang/minecraftpe/MainActivity:mcPkgInfo	Landroid/content/pm/PackageInfo;
    //   329: getfield 885	android/content/pm/PackageInfo:versionName	Ljava/lang/String;
    //   332: ldc_w 906
    ...
    //   348: getfield 885	android/content/pm/PackageInfo:versionName	Ljava/lang/String;
    //   351: ldc -106
    //   353: invokevirtual 888	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   356: ifeq +7 -> 363
    //   359: iload_2
    //   360: ifeq +905 -> 1265
    //   363: aload_0
    //   364: getfield 336	com/mojang/minecraftpe/MainActivity:mcPkgInfo	Landroid/content/pm/PackageInfo;
    //   367: getfield 885	android/content/pm/PackageInfo:versionName	Ljava/lang/String;
    //   370: ldc 123
    //   372: invokevirtual 888	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   375: ifeq +728 -> 1103
    //   378: goto +887 -> 1265
    //   381: iload_2
    //   382: ifne +66 -> 448
    ...
    //   407: getfield 885	android/content/pm/PackageInfo:versionName	Ljava/lang/String;
    ...
    //   448: aload_0
    //   449: invokespecial 2125	com/mojang/minecraftpe/MainActivity:checkForSubstrate	()V
    //   452: aload_0
    //   453: invokespecial 2127	com/mojang/minecraftpe/MainActivity:fixMyEpicFail	()V
    //   456: aload_0
    //   457: invokevirtual 2129	com/mojang/minecraftpe/MainActivity:migrateToPatchManager	()V
    //   460: iconst_1
    ...
    //   487: ldc_w 2131
    //   490: invokevirtual 985	java/io/PrintStream:println	(Ljava/lang/String;)V
    //   493: aload 7
    ...
    //   514: aload_0
    //   515: invokespecial 2132	com/mojang/minecraftpe/MainActivity:disableAllPatches	()V
    //   518: iconst_1
    //   519: istore_2
    //   520: aload 7
    //   522: ldc_w 2134
    ...
    //   583: ldc_w 2136
    //   586: ldc_w 288
    //   589: invokeinterface 1459 3 0
    //   594: ldc_w 2138
    //   597: invokevirtual 1714	java/lang/String:indexOf	(Ljava/lang/String;)I
    //   600: iflt +10 -> 610
    //   603: aload_0
    //   604: sipush 4102
    //   607: invokevirtual 1033	com/mojang/minecraftpe/MainActivity:showDialog	(I)V
    //   610: aload_0
    ...
    //   623: aload_0
    //   624: aload_0
    //   625: putfield 1651	com/mojang/minecraftpe/MainActivity:minecraftApkContext	Landroid/content/Context;
    //   628: invokestatic 2141	net/zhuoweizhang/mcpelauncher/Utils:setLanguageOverride	()V
    //   631: aload_0
    ...
    //   652: invokeinterface 2146 1 0
    //   657: aload_0
    //   658: invokevirtual 2148	com/mojang/minecraftpe/MainActivity:loadTexturePack	()V
    //   661: aload_0
    //   662: invokevirtual 2150	com/mojang/minecraftpe/MainActivity:allowScriptOverrideTextures	()Z
    //   665: ifeq +21 -> 686
    //   668: aload_0
    //   669: getfield 284	com/mojang/minecraftpe/MainActivity:textureOverrides	Ljava/util/List;
    //   672: new 2152	net/zhuoweizhang/mcpelauncher/ScriptOverrideTexturePack
    //   675: dup
    //   676: aload_0
    //   677: invokespecial 2153	net/zhuoweizhang/mcpelauncher/ScriptOverrideTexturePack:<init>	(Landroid/content/Context;)V
    //   680: invokeinterface 1046 2 0
    //   685: pop
    //   686: aload_0
    //   687: invokestatic 2158	net/zhuoweizhang/mcpelauncher/ScriptTextureDownloader:attachCache	(Landroid/content/Context;)V
    //   690: aload_0
    //   691: aload_0
    //   692: invokevirtual 2160	com/mojang/minecraftpe/MainActivity:doesRequireGuiBlocksPatch	()Z
    ...
    //   708: ldc_w 2162
    //   711: iconst_1
    //   712: invokeinterface 918 3 0
    //   717: ifne +15 -> 732
    //   720: aload_0
    //   721: invokevirtual 1050	com/mojang/minecraftpe/MainActivity:getMCPEVersion	()Ljava/lang/String;
    //   724: ldc 123
    //   726: invokevirtual 888	java/lang/String:startsWith	(Ljava/lang/String;)Z
    //   729: ifeq +7 -> 736
    //   732: aload_0
    //   733: invokespecial 2164	com/mojang/minecraftpe/MainActivity:prePatch	()V
    //   736: new 537	java/lang/StringBuilder
    //   739: dup
    //   740: invokespecial 538	java/lang/StringBuilder:<init>	()V
    //   743: aload_0
    //   744: getfield 963	com/mojang/minecraftpe/MainActivity:mcAppInfo	Landroid/content/pm/ApplicationInfo;
    ...
    //   772: aload_0
    //   773: getfield 963	com/mojang/minecraftpe/MainActivity:mcAppInfo	Landroid/content/pm/ApplicationInfo;
    ...
    //   800: aload_0
    //   801: invokestatic 2173	org/fmod/FMOD:init	(Landroid/content/Context;)V
    //   804: iconst_1
    ...
    //   811: ifeq +10 -> 821
    //   814: aload_0
    //   815: invokespecial 2175	com/mojang/minecraftpe/MainActivity:requiresPatchingInSafeMode	()Z
    //   818: ifeq +83 -> 901
    //   821: aload_0
    //   822: invokevirtual 2177	com/mojang/minecraftpe/MainActivity:initPatching	()V
    //   825: getstatic 2179	com/mojang/minecraftpe/MainActivity:minecraftLibBuffer	Ljava/nio/ByteBuffer;
    //   828: ifnull +73 -> 901
    //   831: iconst_0
    //   832: invokestatic 789	net/zhuoweizhang/mcpelauncher/Utils:getPrefs	(I)Landroid/content/SharedPreferences;
    //   835: ldc_w 2181
    //   838: iconst_0
    //   839: invokeinterface 918 3 0
    //   844: istore 6
    //   846: aload_0
    //   847: invokevirtual 2183	com/mojang/minecraftpe/MainActivity:hasScriptSupport	()Z
    //   850: ifne +357 -> 1207
    //   853: iconst_1
    //   854: istore 5
    //   856: iload 6
    //   858: aload_0
    //   859: iload 5
    //   861: invokestatic 2187	net/zhuoweizhang/mcpelauncher/ScriptManager:nativePrePatch	(ZLcom/mojang/minecraftpe/MainActivity;Z)V
    //   864: aload_0
    //   865: invokevirtual 2183	com/mojang/minecraftpe/MainActivity:hasScriptSupport	()Z
    //   868: ifeq +23 -> 891
    //   871: iconst_0
    //   872: invokestatic 789	net/zhuoweizhang/mcpelauncher/Utils:getPrefs	(I)Landroid/content/SharedPreferences;
    //   875: ldc_w 2189
    //   878: iconst_0
    //   879: invokeinterface 918 3 0
    //   884: ifeq +7 -> 891
    //   887: iconst_1
    //   888: invokestatic 2192	net/zhuoweizhang/mcpelauncher/ScriptManager:nativeModPESetDesktopGui	(Z)V
    //   891: invokestatic 836	net/zhuoweizhang/mcpelauncher/Utils:isSafeMode	()Z
    //   894: ifne +7 -> 901
    //   897: aload_0
    //   898: invokevirtual 2194	com/mojang/minecraftpe/MainActivity:loadNativeAddons	()V
    //   901: aload_0
    //   902: invokevirtual 2183	com/mojang/minecraftpe/MainActivity:hasScriptSupport	()Z
    //   905: istore 5
    //   907: invokestatic 836	net/zhuoweizhang/mcpelauncher/Utils:isSafeMode	()Z
    //   910: ifne +51 -> 961
    //   913: getstatic 2179	com/mojang/minecraftpe/MainActivity:minecraftLibBuffer	Ljava/nio/ByteBuffer;
    //   916: ifnull +45 -> 961
    //   919: aload_0
    //   920: invokevirtual 2057	com/mojang/minecraftpe/MainActivity:applyBuiltinPatches	()V
    //   923: iload 5
    //   925: ifeq +36 -> 961
    //   928: iconst_0
    ...
    //   932: ldc_w 2196
    //   935: iconst_1
    //   936: invokeinterface 918 3 0
    //   941: ifeq +20 -> 961
    //   944: aload_0
    //   945: invokestatic 2197	net/zhuoweizhang/mcpelauncher/ScriptManager:init	(Landroid/content/Context;)V
    //   948: aload_0
    //   949: getfield 284	com/mojang/minecraftpe/MainActivity:textureOverrides	Ljava/util/List;
    //   952: getstatic 2201	net/zhuoweizhang/mcpelauncher/ScriptManager:modPkgTexturePack	Lnet/zhuoweizhang/mcpelauncher/texture/ModPkgTexturePack;
    //   955: invokeinterface 1046 2 0
    //   960: pop
    ...
    //   969: ifne +7 -> 976
    //   972: aload_0
    //   973: invokestatic 2204	net/zhuoweizhang/mcpelauncher/ScriptManager:loadEnabledScriptsNames	(Landroid/content/Context;)V
    //   976: iload_2
    //   977: ifeq +6 -> 983
    //   980: invokestatic 2207	net/zhuoweizhang/mcpelauncher/ScriptManager:clearTextureOverrides	()V
    //   983: aload_0
    //   984: invokespecial 2209	com/mojang/minecraftpe/MainActivity:initAtlasMeta	()V
    //   987: aload_0
    //   988: new 1643	android/util/DisplayMetrics
    //   991: dup
    //   992: invokespecial 2210	android/util/DisplayMetrics:<init>	()V
    //   995: putfield 1641	com/mojang/minecraftpe/MainActivity:displayMetrics	Landroid/util/DisplayMetrics;
    //   998: aload_0
    //   999: iconst_3
    //   1000: invokevirtual 2213	com/mojang/minecraftpe/MainActivity:setVolumeControlStream	(I)V
    //   1003: aload_0
    //   1004: invokevirtual 2217	com/mojang/minecraftpe/MainActivity:getWindowManager	()Landroid/view/WindowManager;
    //   1007: invokeinterface 2223 1 0
    //   1012: aload_0
    //   1013: getfield 1641	com/mojang/minecraftpe/MainActivity:displayMetrics	Landroid/util/DisplayMetrics;
    //   1016: invokevirtual 2229	android/view/Display:getMetrics	(Landroid/util/DisplayMetrics;)V
    //   1019: aload_0
    //   1020: getstatic 244	com/mojang/minecraftpe/MainActivity:MC_NATIVE_LIBRARY_DIR	Ljava/lang/String;
    //   1023: invokespecial 2231	com/mojang/minecraftpe/MainActivity:addLibraryDirToPath	(Ljava/lang/String;)V
    //   1026: aload_0
    //   1027: iconst_1
    //   1028: invokespecial 2233	com/mojang/minecraftpe/MainActivity:setFakePackage	(Z)V
    //   1031: aload_0
    //   1032: aload_1
    //   1033: invokespecial 2235	android/app/NativeActivity:onCreate	(Landroid/os/Bundle;)V
    //   1036: aload_0
    //   1037: invokevirtual 2237	com/mojang/minecraftpe/MainActivity:nativeRegisterThis	()V
    //   1040: aload_0
    //   1041: iconst_0
    //   1042: invokespecial 2233	com/mojang/minecraftpe/MainActivity:setFakePackage	(Z)V
    //   1045: aload_0
    //   1046: iconst_1
    //   1047: invokestatic 2241	net/zhuoweizhang/mcpelauncher/Utils:setupTheme	(Landroid/content/Context;Z)V
    //   1050: aload_0
    //   1051: invokespecial 2243	com/mojang/minecraftpe/MainActivity:disableTransparentSystemBar	()V
    //   1054: new 2245	java/net/CookieManager
    //   1057: dup
    //   1058: invokespecial 2246	java/net/CookieManager:<init>	()V
    //   1061: invokestatic 2252	java/net/CookieHandler:setDefault	(Ljava/net/CookieHandler;)V
    ...
    //   1077: aload_0
    //   1078: sipush 4106
    //   1081: invokevirtual 1033	com/mojang/minecraftpe/MainActivity:showDialog	(I)V
    //   1084: aload_0
    //   1085: invokevirtual 2254	com/mojang/minecraftpe/MainActivity:initKamcord	()V
    //   1088: invokestatic 2257	java/lang/System:gc	()V
    //   1091: return
    //   1092: iconst_0
    //   1093: istore 5
    //   1095: goto -861 -> 234
    ...
    //   1108: astore_1
    //   1109: aload_1
    //   1110: invokevirtual 2258	android/content/pm/PackageManager$NameNotFoundException:printStackTrace	()V
    //   1113: aload_0
    ...
    //   1149: ldc_w 2091
    //   1152: iconst_2
    //   1153: invokevirtual 2262	com/mojang/minecraftpe/MainActivity:createPackageContext	(Ljava/lang/String;I)Landroid/content/Context;
    //   1156: putfield 1651	com/mojang/minecraftpe/MainActivity:minecraftApkContext	Landroid/content/Context;
    //   1159: goto -531 -> 628
    //   1162: astore 7
    //   1164: aload 7
    ...
    //   1170: ldc_w 2264
    //   1173: iconst_1
    //   1174: invokestatic 2270	android/widget/Toast:makeText	(Landroid/content/Context;Ljava/lang/CharSequence;I)Landroid/widget/Toast;
    //   1177: invokevirtual 2272	android/widget/Toast:show	()V
    //   1180: aload_0
    ...
    //   1220: aload_0
    //   1221: aload 7
    //   1223: invokevirtual 880	com/mojang/minecraftpe/MainActivity:reportError	(Ljava/lang/Throwable;)V
    //   1226: goto -325 -> 901
    //   1229: astore 7
    //   1231: aload 7
    ...
    //   1236: aload_0
    //   1237: aload 7
    //   1239: invokevirtual 880	com/mojang/minecraftpe/MainActivity:reportError	(Ljava/lang/Throwable;)V
    //   1242: goto -266 -> 976
    //   1245: aload_0
    //   1246: sipush 4096
    //   1249: invokevirtual 1033	com/mojang/minecraftpe/MainActivity:showDialog	(I)V
    //   1252: goto -168 -> 1084
    //   1255: astore 7
    //   1257: goto -809 -> 448
    //   1260: iconst_1
    ...
    throws IOException
  {
    if (getMCPEVersion().startsWith("0.15")) {
      try
      {
        InputStream localInputStream = getAssets().open("15/" + paramString);
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\mojang\minecraftpe\MainActivity.class
