...
public class FitnessActivities
{
  ...
  {
    Object localObject;
    if ((paramInt < 0) || (paramInt >= zzavS.length)) {
      localObject = "unknown";
    }
    String str;
    do
  ...
  {
    int i = 0;
    while (i < zzavS.length)
    {
      if (zzavS[i].equals(paramString)) {
        return i;
      }
      i += 1;
    }
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\google\android\gms\fitness\FitnessActivities.class
