...
public abstract interface ILocationSourceDelegate
  extends IInterface
{
  public abstract void activate(zzk paramzzk)
    ...
    implements ILocationSourceDelegate
  {
      ...
      throws RemoteException
    {
      ...
      case 1: 
        ...
        activate(zzk.zza.zzcG(paramParcel1.readStrongBinder()));
      ...
      implements ILocationSourceDelegate
    {
        ...
        throws RemoteException
      {
        ...
        //   30: aload_0
        //   31: getfield 18	com/google/android/gms/maps/internal/ILocationSourceDelegate$zza$zza:zzoz	Landroid/os/IBinder;
        //   34: iconst_1
        //   35: aload_2
        //   36: aload_3
        //   37: iconst_0
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\google\android\gms\maps\internal\ILocationSourceDelegate.class
