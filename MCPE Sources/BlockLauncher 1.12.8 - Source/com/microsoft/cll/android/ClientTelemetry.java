...
public class ClientTelemetry
{
  ...
  protected void IncremenetRejectDropCount(int paramInt)
  {
  ...
  protected void SetAvgSettingsLatencyMs(int paramInt)
  {
    ...
    for (paramInt = 0; localIterator.hasNext(); paramInt = ((Integer)localIterator.next()).intValue() + paramInt) {}
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\microsoft\cll\android\ClientTelemetry.class
