  ...
  extends ScheduledWorker
{
  ...
  private void GetCloudSettings()
  {
    ...
    while (localIterator.hasNext())
    {
      ...
      if (localJSONObject == null) {
        this.logger.error("SettingsSync", "Could not get or parse settings");
      } else {
  ...
  public void run()
  {
    this.logger.info("SettingsSync", "Cloud sync!");
    GetCloudSettings();
  }
}


/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\microsoft\cll\android\SettingsSync.class
