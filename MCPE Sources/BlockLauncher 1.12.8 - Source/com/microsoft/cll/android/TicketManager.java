  ...
  public void addTickets(List<String> paramList)
  {
    ...
    for (;;)
    {
      ...
      while (localIterator.hasNext())
      {
        ...
        {
          this.logger.info("TicketManager", "Getting ticket for " + str2);
        ...
        {
          this.logger.info("TicketManager", "We already have a ticket for this id, skipping.");
        }
      }
    }
  }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\microsoft\cll\android\TicketManager.class
