...
public class Settings
{
  ...
  public static String getSetting(String paramString)
  {
    ...
    try
    {
      String str1 = _storage.readString(paramString, (String)_defaultSettingsMap.get(paramString));
      String str2 = str1;
      if (str1 == null) {
        str2 = (String)_defaultSettingsMap.get(paramString);
      }
      return str2;
    }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\microsoft\onlineid\internal\configuration\Settings.class
