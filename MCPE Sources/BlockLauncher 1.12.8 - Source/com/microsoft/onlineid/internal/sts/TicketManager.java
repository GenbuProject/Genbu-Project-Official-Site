...
public class TicketManager
{
  ...
  {
    return getTicket(paramString1, paramISecurityScope, this._applicationContext.getPackageName(), paramString2, false, null, null);
  }
  ...
  public Ticket getTicket(String paramString1, ISecurityScope paramISecurityScope, String paramString2, String paramString3, String paramString4)
    throws AccountNotFoundException, InvalidResponseException, StsException, NetworkException, PromptNeededException
  {
    return getTicket(paramString1, paramISecurityScope, paramString2, paramString3, false, paramString4, null);
  }
  
  public Ticket getTicket(String paramString1, ISecurityScope paramISecurityScope, String paramString2, String paramString3, boolean paramBoolean, String paramString4, Bundle paramBundle)
    throws AccountNotFoundException, InvalidResponseException, StsException, NetworkException, PromptNeededException
  {
    ...
    paramISecurityScope = performServiceRequest((AuthenticatorUserAccount)localObject, paramISecurityScope, paramString2, paramString3, paramBoolean, paramString4, paramBundle);
    Assertion.check(paramISecurityScope.succeeded(), "Service request failure not handled by performServiceRequest");
    updateAccountDetails(paramString1, paramISecurityScope, paramBoolean);
    ...
    throws NetworkException, PromptNeededException, InvalidResponseException, StsException
  {
    ...
    Logger.info("Attempting to get ticket from server: " + paramISecurityScope.toString());
    paramAuthenticatorUserAccount = performServiceRequest(paramAuthenticatorUserAccount, paramISecurityScope, paramString1, paramString2, false, null, null);
  ...
  protected ServiceResponse performServiceRequest(AuthenticatorUserAccount paramAuthenticatorUserAccount, ISecurityScope paramISecurityScope, String paramString1, String paramString2, boolean paramBoolean, String paramString3, Bundle paramBundle)
    throws NetworkException, InvalidResponseException, StsException, PromptNeededException
  {
    ...
    ServiceResponse localServiceResponse = (ServiceResponse)this._stsRequestFactory.createServiceRequest(paramAuthenticatorUserAccount, (DeviceIdentity)localObject, paramISecurityScope, paramString1, paramString2, paramBoolean).send();
    ...
    if (!localServiceResponse.succeeded())
    {
      ...
      if (localServiceResponse.getError().isRetryableDeviceDAErrorForUserAuth())
      {
        ...
        localObject = (ServiceResponse)this._stsRequestFactory.createServiceRequest(paramAuthenticatorUserAccount, (DeviceIdentity)localObject, paramISecurityScope, paramString1, paramString2, paramBoolean).send();
      }
    }
    ...
    if (!((ServiceResponse)localObject).succeeded())
    {
      ...
      if (localObject != null)
      {
        ...
        paramAuthenticatorUserAccount = InterruptResolutionActivity.getResolutionIntent(this._applicationContext, ((Uri.Builder)localObject).build(), paramAuthenticatorUserAccount, paramISecurityScope, paramString3, paramString1, paramBundle);
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\microsoft\onlineid\internal\sts\TicketManager.class
