  ...
  extends ServiceOperation
{
    ...
    throws AccountNotFoundException, InvalidResponseException, NetworkException, StsException, InternalException
  {
    ...
    localObject2 = new TicketManager(getContext()).createTicketRequest(((AuthenticatorUserAccount)localObject2).getPuid(), localISecurityScope, getCallingPackage(), str, getCallerStateBundle()).setIsSdkRequest(true).setResultReceiver((ResultReceiver)localObject1);
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\microsoft\onlineid\internal\sso\service\operation\GetTicketOperation.class
