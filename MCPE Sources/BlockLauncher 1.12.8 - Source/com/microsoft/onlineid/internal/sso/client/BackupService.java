  ...
  extends IntentService
{
  ...
  protected void retrieveAndPushBackup()
  {
    ...
    if (this._applicationContext.getPackageName().equals(((SsoService)localList.get(0)).getPackageName()))
    {
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\microsoft\onlineid\internal\sso\client\BackupService.class
