  ...
  extends Activity
{
  ...
  {
    this._javaScriptBridge = new JavaScriptBridge(this);
    this._webView.addJavascriptInterface(this._javaScriptBridge, "external");
    WebSettings localWebSettings = this._webView.getSettings();
    localWebSettings.setUserAgentString(Transport.mergeUserAgentStrings(localWebSettings.getUserAgentString(), Transport.buildUserAgentString(getApplicationContext())));
    localWebSettings.setJavaScriptEnabled(true);
    localWebSettings.setJavaScriptCanOpenWindowsAutomatically(true);
    localWebSettings.setSupportMultipleWindows(true);
    this._webView.setWebViewClient(new HostedWebViewClient(null));
  ...
  public static ApiRequest getFlowRequest(Context paramContext, Uri paramUri, String paramString, boolean paramBoolean)
  {
    new ApiRequest(paramContext, new Intent().setClass(paramContext, WebFlowActivity.class).setAction(paramString).setData(paramUri).putExtra("com.microsoft.onlineid.internal.ui.FullScreen", paramBoolean))
    {
  ...
  public void sendResult(int paramInt, Bundle paramBundle)
  {
    ...
    if ((localIntent != null) && (paramInt == -1)) {
      localApiRequest.sendSuccess(new ApiResult(paramBundle));
    }
    for (;;)
    {
      finish();
    ...
    if (paramBundle != null) {}
    for (paramBundle = new Intent().putExtras(paramBundle);; paramBundle = null)
    {
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\microsoft\onlineid\internal\ui\WebFlowActivity.class
