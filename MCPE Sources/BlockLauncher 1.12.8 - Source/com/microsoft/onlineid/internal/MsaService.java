  ...
  extends IntentService
{
  ...
  protected void onHandleIntent(Intent paramIntent)
  {
    ...
    try
    {
      ...
      {
        Ticket localTicket = this._ticketManager.getTicket(str, localApiRequest.getScope(), localApiRequest.getClientPackageName(), localApiRequest.getFlowToken(), false, localApiRequest.getCobrandingId(), localApiRequest.getClientStateBundle());
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\microsoft\onlineid\internal\MsaService.class
