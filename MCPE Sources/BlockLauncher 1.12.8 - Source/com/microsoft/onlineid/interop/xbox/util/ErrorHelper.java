...
import com.microsoft.onlineid.interop.Interop.ErrorType;
import com.microsoft.onlineid.interop.xbox.ui.ErrorActivity;
import com.microsoft.onlineid.interop.xbox.ui.ErrorActivity.ErrorScreen;
  ...
  implements Parcelable
{
  ...
  public <D> boolean initLoader(int paramInt, Bundle paramBundle)
  {
    ...
    if (paramInt != -1)
    {
      ...
      {
        if ((!bool) && (localLoaderManager.getLoader(paramInt) == null) && (!isConnected())) {
          break label160;
        }
  ...
  {
    Activity localActivity = this.activityContext.getActivity();
    Intent localIntent = new Intent(localActivity, ErrorActivity.class);
    localIntent.putExtra("ARG_ERROR_TYPE", paramErrorScreen.type.getId());
    localIntent.putExtra("ARG_XTOKEN", localActivity.getIntent().getStringExtra("ARG_XTOKEN"));
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\com\microsoft\onlineid\interop\xbox\util\ErrorHelper.class
