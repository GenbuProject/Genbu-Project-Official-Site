...
abstract class Icode
{
  ...
  {
    return (-64 <= paramInt) && (paramInt <= 0);
  }
  
  static boolean validTokenCode(int paramInt)
  {
    return (2 <= paramInt) && (paramInt <= 81);
  }
}


/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\org\mozilla\javascript\Icode.class
