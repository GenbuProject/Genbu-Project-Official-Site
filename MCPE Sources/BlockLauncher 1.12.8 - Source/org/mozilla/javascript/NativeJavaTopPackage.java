  ...
  implements Function, IdFunctionCall
{
  ...
  static
  {
    ...
    String[] arrayOfString2 = { "java", "applet" };
    String[] arrayOfString3 = { "javax", "swing" };
    commonPackages = new String[][] { { "java", "lang", "reflect" }, { "java", "io" }, arrayOfString1, { "java", "net" }, { "java", "util", "zip" }, { "java", "text", "resources" }, arrayOfString2, arrayOfString3 };
  }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\org\mozilla\javascript\NativeJavaTopPackage.class
