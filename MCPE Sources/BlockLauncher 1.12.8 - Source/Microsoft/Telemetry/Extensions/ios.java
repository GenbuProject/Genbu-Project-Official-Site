  ...
  extends Extension
{
  ...
  {
    int i;
    if (super.memberwiseCompareDeep(paramios))
    {
      i = 1;
      if (i == 0) {
        break label42;
  ...
  protected boolean memberwiseCompareQuick(ios paramios)
  {
    ...
    label23:
    int j;
    if (super.memberwiseCompareQuick(paramios))
    {
      i = 1;
      if (i == 0) {
        break label67;
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.12.8.jar!\Microsoft\Telemetry\Extensions\ios.class
