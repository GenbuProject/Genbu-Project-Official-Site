  ...
  implements TexturePack
{
  ...
  public AddonOverrideTexturePack(MainActivity paramMainActivity)
  {
  ...
  public InputStream getInputStream(String paramString)
    throws IOException
  {
    paramString = "assets/" + paramString;
    ZipFile localZipFile = (ZipFile)this.assets.get(paramString);
    if (localZipFile == null) {
      return null;
    }
    return localZipFile.getInputStream(localZipFile.getEntry(paramString));
  }
    ...
    throws IOException
  {
    ...
    return localZipFile.getEntry(paramString).getSize();
  }
