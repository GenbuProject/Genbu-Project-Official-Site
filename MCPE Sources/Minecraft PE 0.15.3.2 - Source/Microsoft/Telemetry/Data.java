  ...
  extends Base
{
    ...
    throws IOException
  {
    ...
    catch (IllegalAccessException paramProtocolReader) {}catch (InstantiationException paramProtocolReader) {}
  }
  ...
  {
    return (1 != 0) && (super.memberwiseCompareDeep(paramData));
  }
  
  protected boolean memberwiseCompareQuick(Data<TDomain> paramData)
  {
    return (1 != 0) && (super.memberwiseCompareQuick(paramData));
  }
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\Microsoft\Telemetry\Data.class
