  ...
  extends Extension
{
  ...
  public boolean memberwiseCompare(Object paramObject)
  {
    ...
    {
      return false;
      paramObject = (ios)paramObject;
    } while ((!memberwiseCompareQuick((ios)paramObject)) || (!memberwiseCompareDeep((ios)paramObject)));
    return true;
  }
  
  protected boolean memberwiseCompareDeep(ios paramios)
  {
    int i;
    if ((1 != 0) && (super.memberwiseCompareDeep(paramios)))
    {
      i = 1;
      if (i == 0) {
        break label46;
    ...
    label32:
    while (this.libVer.equals(paramios.libVer))
    {
      return true;
      i = 0;
      break;
  ...
  protected boolean memberwiseCompareQuick(ios paramios)
  {
    int i;
    label27:
    int j;
    if ((1 != 0) && (super.memberwiseCompareQuick(paramios)))
    {
      i = 1;
      if (i == 0) {
        break label71;
    ...
    label71:
    label76:
    while (this.libVer.length() == paramios.libVer.length())
    {
      return true;
      i = 0;
      break;
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\Microsoft\Telemetry\Extensions\ios.class
