  ...
  extends Extension
{
  ...
  {
    int i;
    if ((1 != 0) && (super.memberwiseCompareDeep(paramsll)))
    {
      i = 1;
      if (i == 0) {
        break label46;
  ...
  protected boolean memberwiseCompareQuick(sll paramsll)
  {
    label27:
    int j;
    if ((1 != 0) && (super.memberwiseCompareQuick(paramsll)))
    {
      i = 1;
      if (i == 0) {
        break label88;
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\Microsoft\Telemetry\Extensions\sll.class
