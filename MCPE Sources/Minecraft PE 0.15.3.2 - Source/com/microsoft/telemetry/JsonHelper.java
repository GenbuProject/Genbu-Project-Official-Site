...
public final class JsonHelper
{
  ...
  public static void writeListString(Writer paramWriter, List<String> paramList)
    throws IOException
  {
    if ((paramList == null) || (paramList.isEmpty())) {
      paramWriter.write("null");
    ...
    paramWriter.write("[");
    paramWriter.write(convert((String)paramList.next()));
    while (paramList.hasNext())
    {
      String str = (String)paramList.next();
      paramWriter.write(",");
      paramWriter.write(convert(str));
    }
    paramWriter.write("]");
  }
}
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\telemetry\JsonHelper.class
