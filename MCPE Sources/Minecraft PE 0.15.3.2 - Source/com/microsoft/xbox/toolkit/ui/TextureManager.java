...
public class TextureManager
{
  ...
  private XLEMemoryCache<TextureManagerScaledNetworkBitmapRequest, XLEBitmap> bitmapCache = new XLEMemoryCache(Math.min(getNetworkBitmapCacheSizeInMB(), 50) * 1048576, 5242880);
  ...
  {
    XLEBitmap localXLEBitmap1 = paramXLEBitmap;
    XLEBitmap localXLEBitmap2 = localXLEBitmap1;
    float f;
    if (validResizeDimention(paramInt1, paramInt2))
    {
      localXLEBitmap2 = localXLEBitmap1;
    ...
    for (;;)
    {
      localXLEBitmap2 = XLEBitmap.createScaledBitmap8888(paramXLEBitmap, paramInt1, paramInt2, true);
      return localXLEBitmap2;
      label79:
      paramInt2 = Math.max(1, (int)(paramInt1 * f));
    }
  }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      for (;;)
      {
        localTextureManagerDownloadRequest = (TextureManagerDownloadRequest)TextureManager.this.toDecode.pop();
        ...
        catch (Exception localException)
        {
          for (;;)
          {
            ...
            if (localTextureManagerDownloadRequest.key.bindingOption.resourceIdForError != -1)
            {
              ...
              localObject4 = (TextureManager.RetryEntry)TextureManager.this.timeToRetryCache.get(localTextureManagerDownloadRequest.key);
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\xbox\toolkit\ui\TextureManager.class
