...
public class TextureBindingOption
{
  ...
  public boolean equals(Object paramObject)
  {
    ...
    {
      return true;
      if (!(paramObject instanceof TextureBindingOption)) {
        return false;
      }
      paramObject = (TextureBindingOption)paramObject;
    } while ((this.width == ((TextureBindingOption)paramObject).width) && (this.height == ((TextureBindingOption)paramObject).height) && (this.resourceIdForError == ((TextureBindingOption)paramObject).resourceIdForError) && (this.resourceIdForLoading == ((TextureBindingOption)paramObject).resourceIdForLoading));
    return false;
  }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\xbox\toolkit\ui\TextureBindingOption.class
