  ...
  public static XLEFileCache createCache(String paramString, int paramInt, boolean paramBoolean)
  {
    ...
    for (;;)
    {
      ...
      else
      {
        ...
        break label179;
        paramString = localXLEFileCache;
        if (localXLEFileCache.maxFileNumber != paramInt) {
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\xbox\toolkit\XLEFileCacheManager.class
