...
public class SystemUtil
{
  ...
  public static boolean isSlate()
  {
    ...
    return Math.sqrt(Math.pow(f1, 2.0D) + Math.pow(f2, 2.0D)) > 6.0D;
  }
}


/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\xbox\toolkit\system\SystemUtil.class
