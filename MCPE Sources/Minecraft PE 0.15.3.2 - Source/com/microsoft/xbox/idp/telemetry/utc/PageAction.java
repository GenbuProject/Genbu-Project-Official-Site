  ...
  extends Data<CommonData>
{
  ...
  public boolean memberwiseCompare(Object paramObject)
  {
    ...
    {
      return false;
      paramObject = (PageAction)paramObject;
    } while ((!memberwiseCompareQuick((PageAction)paramObject)) || (!memberwiseCompareDeep((PageAction)paramObject)));
    return true;
  }
  
  protected boolean memberwiseCompareDeep(PageAction paramPageAction)
  {
    int i;
    if ((1 != 0) && (super.memberwiseCompareDeep(paramPageAction)))
    {
      i = 1;
      if (i == 0) {
        break label59;
    ...
    label59:
    label64:
    while (this.pageName.equals(paramPageAction.pageName))
    {
      return true;
      i = 0;
      break;
      if (this.actionName.equals(paramPageAction.actionName)) {
        break label25;
      }
      i = 0;
      break label27;
  ...
  protected boolean memberwiseCompareQuick(PageAction paramPageAction)
  {
    int i;
    label27:
    int j;
    if ((1 != 0) && (super.memberwiseCompareQuick(paramPageAction)))
    {
      i = 1;
      if (i == 0) {
        break label113;
      ...
      i = 1;
      if (paramPageAction.actionName != null) {
        break label108;
      }
      j = 1;
      label36:
      ...
      i = 1;
      label69:
      if (paramPageAction.pageName != null) {
        break label145;
      }
      j = 1;
      label78:
    ...
    label150:
    label155:
    while (this.pageName.length() == paramPageAction.pageName.length())
    {
      return true;
      i = 0;
      break;
      ...
      i = 0;
      break label43;
      if (this.actionName.length() == paramPageAction.actionName.length()) {
        break label54;
      }
      i = 0;
      break label56;
    ...
    throws IOException
  {
    ...
    {
      return false;
      this.actionName = ReadHelper.readWString(paramProtocolReader, localFieldTag.type);
    }
    for (;;)
    {
    ...
    throws IOException
  {
    ...
    if ((!bool) || (!paramProtocolReader.readFieldOmitted())) {
      this.actionName = paramProtocolReader.readWString();
    }
    if ((!bool) || (!paramProtocolReader.readFieldOmitted())) {
  ...
  public final void setActionName(String paramString)
  {
  ...
  public void setField(FieldDef paramFieldDef, Object paramObject)
  {
    ...
    default: 
      return;
    case 10: 
      this.actionName = ((String)paramObject);
      return;
    }
    ...
    throws IOException
  {
    ...
    paramProtocolWriter.writeFieldBegin(BondDataType.BT_WSTRING, 10, Schema.actionName_metadata);
    paramProtocolWriter.writeWString(this.actionName);
    paramProtocolWriter.writeFieldEnd();
    paramProtocolWriter.writeFieldBegin(BondDataType.BT_WSTRING, 20, Schema.pageName_metadata);
  ...
  public static class Schema
  {
    ...
    private static short getStructDef(SchemaDef paramSchemaDef)
    {
      ...
      paramSchemaDef.setMetadata(actionName_metadata);
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\xbox\idp\telemetry\utc\PageAction.class
