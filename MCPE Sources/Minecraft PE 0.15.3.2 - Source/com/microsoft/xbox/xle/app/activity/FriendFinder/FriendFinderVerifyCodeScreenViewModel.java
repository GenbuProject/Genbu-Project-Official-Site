  ...
  extends ViewModelBase
{
    ...
    protected AsyncActionStatus loadDataInBackground()
    {
      for (;;)
      {
        ...
        try
        {
          ...
          localObject2 = new ShortCircuitProfileMessage.ShortCircuitProfileRequest(ShortCircuitProfileMessage.MsgType.Add, (String)localObject1, str, this.useVoice);
          localObject2 = ServiceManagerFactory.getInstance().getSLSServiceManager().sendShortCircuitProfile((ShortCircuitProfileMessage.ShortCircuitProfileRequest)localObject2);
    ...
    extends NetworkAsyncTask<AsyncActionStatus>
  {
      ...
      throws XLEException
    {
      ...
      Object localObject2 = PhoneContactInfo.getInstance().getUserEnteredNumber();
      Object localObject1;
      ShortCircuitProfileMessage.ShortCircuitProfileResponse localShortCircuitProfileResponse;
      if (JavaUtil.isNullOrEmpty(str))
      {
        localObject1 = localObject2;
        if (!((String)localObject2).startsWith("+")) {
        ...
        localShortCircuitProfileResponse = ServiceManagerFactory.getInstance().getSLSServiceManager().sendShortCircuitProfile((ShortCircuitProfileMessage.ShortCircuitProfileRequest)localObject2);
        if ((localShortCircuitProfileResponse.error != null) && ((localShortCircuitProfileResponse.error.code == null) || (!localShortCircuitProfileResponse.error.code.equalsIgnoreCase("PhoneAlreadyVerified:PhoneToVerifyTokenAlreadyVerified")))) {
          break label213;
        }
      }
      int k;
      ...
      {
        j = i;
        localObject2 = localShortCircuitProfileResponse;
        if (i != 0) {
          break label327;
        }
        j = i;
      ...
      if (k == 10)
      {
        ...
        localObject2 = ServiceManagerFactory.getInstance().getSLSServiceManager().sendShortCircuitProfile((ShortCircuitProfileMessage.ShortCircuitProfileRequest)localObject1);
      ...
      label327:
      label338:
      for (j = 1; (localObject2 != null) && (j != 0); j = 0) {
        return true;
      }
      return false;
    }
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\xbox\xle\app\activity\FriendFinder\FriendFinderVerifyCodeScreenViewModel.class
