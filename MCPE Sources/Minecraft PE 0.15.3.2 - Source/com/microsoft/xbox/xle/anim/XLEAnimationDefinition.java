...
public class XLEAnimationDefinition
{
  ...
  public Animation getAnimation()
  {
    ...
    while (localObject != null)
    {
      ...
      continue;
      j = XLERValueHelper.findDimensionIdByName(this.dimen);
      int i = 0;
      if (j >= 0) {
        i = XboxTcuiSdk.getResources().getDimensionPixelSize(j);
      }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\xbox\xle\anim\XLEAnimationDefinition.class
