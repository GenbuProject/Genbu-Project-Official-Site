    ...
    for (this.activityBody = findViewById(this.activityBodyIndex);; this.activityBody = this)
    {
      ...
      if ((this.activityBody != null) && (this.activityBody != this))
      {
        ...
        if ((localObject instanceof ViewGroup.MarginLayoutParams))
        {
          ...
          setPadding(getPaddingLeft() + ((ViewGroup.MarginLayoutParams)localObject).leftMargin, getPaddingTop() + ((ViewGroup.MarginLayoutParams)localObject).topMargin, getPaddingRight() + ((ViewGroup.MarginLayoutParams)localObject).rightMargin, this.origPaddingBottom + ((ViewGroup.MarginLayoutParams)localObject).bottomMargin);
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\xbox\xle\ui\XLERootView.class
