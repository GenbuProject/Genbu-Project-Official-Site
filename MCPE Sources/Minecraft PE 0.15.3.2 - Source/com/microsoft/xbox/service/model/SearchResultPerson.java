...
public class SearchResultPerson
{
  ...
  private static List<String> getRuns(String paramString1, String paramString2)
  {
    ...
    if (i != -1)
    {
      ...
      localArrayList.add(paramString1.substring(i + j, paramString1.length()));
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\xbox\service\model\SearchResultPerson.class
