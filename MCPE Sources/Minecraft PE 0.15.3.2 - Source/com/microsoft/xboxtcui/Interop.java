...
public class Interop
{
  ...
  public static void ShowProfileCardUI(Activity paramActivity, String paramString1, String paramString2, String paramString3)
  {
    ...
    Activity localActivity = getForegroundActivity();
    if (localActivity == null) {
      localActivity = paramActivity;
    }
    for (;;)
    {
      final ActivityParameters localActivityParameters = new ActivityParameters();
      localActivityParameters.putMeXuid(paramString1);
      localActivityParameters.putSelectedProfile(paramString2);
      localActivityParameters.putPrivileges(paramString3);
      paramActivity.runOnUiThread(new Runnable()
      {
        public void run()
        {
          try
          {
            XboxTcuiWindowDialog localXboxTcuiWindowDialog = new XboxTcuiWindowDialog(this.val$activityToUse, ProfileScreen.class, localActivityParameters);
            localXboxTcuiWindowDialog.setDetachedCallback(Interop.detachedCallback);
            localXboxTcuiWindowDialog.show();
            return;
          }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\xboxtcui\Interop.class
