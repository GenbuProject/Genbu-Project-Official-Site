...
public class BundleMarshaller
{
  ...
  {
    Bundle localBundle = new Bundle();
    Object localObject = paramOnlineIdConfiguration.getPreferredSignUpMemberNameType();
    if (localObject != OnlineIdConfiguration.PreferredSignUpMemberNameType.None) {
      localBundle.putString("com.microsoft.onlineid.preferred_membername_type", ((OnlineIdConfiguration.PreferredSignUpMemberNameType)localObject).toString());
    }
    localObject = paramOnlineIdConfiguration.getCobrandingId();
    if ((localObject != null) && (!((String)localObject).isEmpty())) {
      localBundle.putString("com.microsoft.onlineid.cobranding_id", (String)localObject);
    }
    if (paramOnlineIdConfiguration.getShouldGatherWebTelemetry()) {
      localBundle.putBoolean("com.microsoft.onlineid.web_telemetry_requested", true);
    }
    return localBundle;
  }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\onlineid\internal\sso\BundleMarshaller.class
