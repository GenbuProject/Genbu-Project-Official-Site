  ...
  public boolean isTrusted(String paramString)
  {
    ...
    for (;;)
    {
      ...
      try
      {
        ...
        str = Base64.encodeToString(localMessageDigest.digest(localObject2[i].toByteArray()), 2);
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\onlineid\internal\sso\SignatureVerifier.class
