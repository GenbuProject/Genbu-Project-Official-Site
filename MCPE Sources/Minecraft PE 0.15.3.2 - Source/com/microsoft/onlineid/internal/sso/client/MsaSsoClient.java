...
public class MsaSsoClient
{
  ...
  public PendingIntent getSignUpIntent(SignUpOptions paramSignUpOptions, OnlineIdConfiguration paramOnlineIdConfiguration, Bundle paramBundle)
    throws AuthenticationException
  {
    return (PendingIntent)performRequestWithFallback(new GetSignUpIntentRequest(this._applicationContext, paramBundle, paramSignUpOptions, paramOnlineIdConfiguration));
  }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\onlineid\internal\sso\client\MsaSsoClient.class
