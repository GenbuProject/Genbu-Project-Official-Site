...
public class TypedStorage
{
  ...
  protected Ticket getTicket(String paramString1, String paramString2, ISecurityScope paramISecurityScope)
  {
  ...
  protected <T> T readFromCollection(String paramString1, String paramString2, ISerializer<T> paramISerializer)
  {
    ...
    //   39: aload_1
    //   40: iconst_1
    //   41: anewarray 82	java/lang/String
    //   44: dup
    //   45: iconst_0
    //   46: aload_2
    //   47: aastore
    //   48: invokevirtual 372	com/microsoft/onlineid/internal/storage/TypedStorage:removeFromCollection	(Ljava/lang/String;[Ljava/lang/String;)V
    //   51: aload_3
    //   52: astore 4
    //   54: aload 4
    //   56: areturn
    //   57: astore_3
    //   58: getstatic 80	java/util/Locale:US	Ljava/util/Locale;
    //   61: ldc_w 374
    //   64: iconst_1
    ...
    //   70: aload_2
    //   71: aastore
    //   72: invokestatic 378	java/lang/String:format	(Ljava/util/Locale;Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   75: invokestatic 381	com/microsoft/onlineid/internal/log/Logger:warning	(Ljava/lang/String;)V
    //   78: aload 5
    //   80: astore 4
    //   82: iconst_0
    //   83: ifne -29 -> 54
    ...
    //   87: aload_1
    //   88: iconst_1
    //   89: anewarray 82	java/lang/String
    //   92: dup
    //   93: iconst_0
    //   94: aload_2
    //   95: aastore
    //   96: invokevirtual 372	com/microsoft/onlineid/internal/storage/TypedStorage:removeFromCollection	(Ljava/lang/String;[Ljava/lang/String;)V
    //   99: aconst_null
    //   100: areturn
    //   101: astore_3
    //   102: iconst_0
    ...
    //   107: aload_1
    //   108: iconst_1
    //   109: anewarray 82	java/lang/String
    //   112: dup
    //   113: iconst_0
    //   114: aload_2
    //   115: aastore
    //   116: invokevirtual 372	com/microsoft/onlineid/internal/storage/TypedStorage:removeFromCollection	(Ljava/lang/String;[Ljava/lang/String;)V
    //   119: aload_3
    //   120: athrow
    // Local variable table:
    //   start	length	slot	name	signature
    //   0	121	0	this	TypedStorage
    //   0	121	1	paramString1	String
    //   0	121	2	paramString2	String
    //   0	121	3	paramISerializer	ISerializer<T>
    //   15	66	4	localObject1	Object
    //   11	68	5	localObject2	Object
    //   8	16	6	str	String
    // Exception table:
    //   from	to	target	type
    //   22	31	57	java/io/IOException
    //   22	31	101	finally
    //   58	78	101	finally
  }
  ...
  protected void removeTicket(String paramString1, String paramString2, ISecurityScope paramISecurityScope)
  {
  ...
  protected void removeTickets(String paramString)
  {
  ...
  {
    ??? = paramBundle.getBundle("com.microsoft.onlineid.backup_device");
    Object localObject1 = null;
    if (??? != null) {
      localObject1 = BundleMarshaller.deviceAccountFromBundle((Bundle)???);
    }
    Object localObject3;
    try
    {
  ...
  protected void storeTicket(String paramString1, String paramString2, Ticket paramTicket)
  {
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\onlineid\internal\storage\TypedStorage.class
