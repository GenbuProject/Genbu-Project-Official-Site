...
public class Storage
{
  ...
  public <T> T readObject(String paramString, ISerializer<T> paramISerializer)
  {
    ...
    try
    {
      ...
      if (str != null) {
        localObject1 = paramISerializer.deserialize(str);
      }
      i = 1;
    }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\onlineid\internal\storage\Storage.class
