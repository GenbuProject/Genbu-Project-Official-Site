      ...
      throws IOException
    {
      ...
      while (paramJsonReader.hasNext())
      {
        ...
        else if ("Value".equals(localObject))
        {
          ...
          switch (ProfileManager.1.$SwitchMap$android$util$JsonToken[localObject.ordinal()])
          {
          default: 
            paramJsonReader.skipValue();
            break;
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\onlineid\internal\profile\ProfileManager.class
