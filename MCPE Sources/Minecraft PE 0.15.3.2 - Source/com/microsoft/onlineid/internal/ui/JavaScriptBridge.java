...
public class JavaScriptBridge
{
  ...
  public JavaScriptBridge(WebFlowActivity paramWebFlowActivity, WebTelemetryRecorder paramWebTelemetryRecorder, WebFlowTelemetryData paramWebFlowTelemetryData)
  {
    this._webFlowActivity = paramWebFlowActivity;
    this._telemetryRecorder = paramWebTelemetryRecorder;
    ...
    populatePropertyBag();
    populateTelemetryData(paramWebFlowTelemetryData);
  }
  ...
  private void populateTelemetryData(WebFlowTelemetryData paramWebFlowTelemetryData)
  {
    try
    {
      Context localContext = this._webFlowActivity.getApplicationContext();
      boolean bool = PackageInfoHelper.isCurrentApp(paramWebFlowTelemetryData.getCallingAppPackageName(), localContext);
      this._propertyBag.set(PropertyBag.Key.TelemetryAppVersion, paramWebFlowTelemetryData.getCallingAppVersionName());
      this._propertyBag.set(PropertyBag.Key.TelemetryIsRequestorMaster, Boolean.toString(bool));
      this._propertyBag.set(PropertyBag.Key.TelemetryNetworkType, NetworkConnectivity.getNetworkTypeForServerTelemetry(localContext));
      this._propertyBag.set(PropertyBag.Key.TelemetryPrecaching, Boolean.toString(paramWebFlowTelemetryData.getWasPrecachingEnabled()));
      return;
    }
    catch (Exception paramWebFlowTelemetryData)
    {
      Logger.error("Encountered error setting telemetry items in property bag.", paramWebFlowTelemetryData);
    }
  }
  ...
  public String Property(String paramString)
  {
    ...
    if ((this._assetBundlePropertyProvider != null) && (this._assetBundlePropertyProvider.handlesProperty(paramString))) {
      return this._assetBundlePropertyProvider.getProperty(paramString);
    }
  ...
  public void Property(String paramString1, String paramString2)
  {
    ...
    {
      if ((this._assetBundlePropertyProvider == null) || (!this._assetBundlePropertyProvider.handlesProperty(paramString1))) {
        break label41;
      }
      this._assetBundlePropertyProvider.setProperty(paramString1, paramString2);
    }
    label41:
    do
    {
    ...
    if (localAuthenticatorUserAccount.isNewAndInOutOfBandInterrupt())
    {
      ...
      for (Object localObject = "ssl.live.com";; localObject = "ssl.live-int.com")
      {
        ...
        catch (PromptNeededException localPromptNeededException)
        {
          ...
          localIntent.putExtra("com.microsoft.onlineid.web_telemetry_requested", this._telemetryRecorder.isRequested());
  ...
  public void setAssetBundlePropertyProvider(IWebPropertyProvider paramIWebPropertyProvider)
  {
    this._assetBundlePropertyProvider = paramIWebPropertyProvider;
  }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\onlineid\internal\ui\JavaScriptBridge.class
