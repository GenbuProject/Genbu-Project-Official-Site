  ...
  extends RelativeLayout
{
  ...
  private void initialize()
  {
    ...
    int i = Dimensions.convertDipToPixels(2.6F, localDisplayMetrics);
    setPadding(0, i, 0, i);
    i = 0;
    while (i < 5)
    {
  ...
  private class ProgressAnimation
  {
    ...
    private void setAnimationParams(int paramInt)
    {
      ...
      float f1 = paramInt / 10.0F + 30.0F;
      int k = Math.round(paramInt * 0.416666F);
      int m = Math.round(paramInt * (1.0F - 2.0F * 0.416666F));
      float f2 = m * 1000 / f1;
      ...
      this._animationDuration = Math.round(f2 + 2.0F * f3 + i * 4.0F + 250.0F);
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\onlineid\internal\ui\ProgressView.class
