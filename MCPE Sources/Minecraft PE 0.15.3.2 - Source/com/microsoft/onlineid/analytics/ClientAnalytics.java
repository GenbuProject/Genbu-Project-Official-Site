  ...
  implements IClientAnalytics
{
  ...
  private ClientAnalytics(Context paramContext)
  {
    ...
    this._tracker.set("&cd1", NetworkConnectivity.getNetworkTypeForAnalytics(paramContext));
  }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\onlineid\analytics\ClientAnalytics.class
