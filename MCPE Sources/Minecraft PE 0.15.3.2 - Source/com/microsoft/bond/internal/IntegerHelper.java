...
public final class IntegerHelper
{
  ...
  {
    return (short)((0xFFFF & paramShort) >>> 1 ^ -(paramShort & 0x1));
  }
  ...
  public static int encodeVarUInt64(long paramLong, byte[] paramArrayOfByte, int paramInt)
  {
    ...
    {
      i = paramInt + 1;
      paramArrayOfByte[paramInt] = ((byte)(int)(0x7F & paramLong | 0x80));
      paramLong >>>= 7;
      paramInt = i;
      l = paramLong;
      if ((0xFFFFFFFFFFFFFF80 & paramLong) == 0L) {
  ...
  {
    return (short)(paramShort << 1 ^ paramShort >> 15);
  }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\bond\internal\IntegerHelper.class
