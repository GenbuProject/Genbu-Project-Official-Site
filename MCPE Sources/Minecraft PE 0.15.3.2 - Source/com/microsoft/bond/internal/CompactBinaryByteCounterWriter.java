  ...
  extends ProtocolWriter
{
    ...
    throws IOException
  {
    ...
    this.positionBytes += IntegerHelper.getVarUInt32Size(i) + i;
  }
    ...
    throws IOException
  {
    ...
    this.positionBytes += IntegerHelper.getVarUInt32Size(paramString.length()) + i;
  }
}


/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\bond\internal\CompactBinaryByteCounterWriter.class
