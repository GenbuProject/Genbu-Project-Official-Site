  ...
  extends ProtocolWriter
{
    ...
    throws IOException
  {
    ...
    if (paramInt <= 5)
    {
      this.stream.write((byte)(paramInt << 5 | i));
      return;
    }
    if (paramInt <= 255)
    {
      this.stream.write((byte)(i | 0xC0));
      this.stream.write((byte)paramInt);
      return;
    }
    this.stream.write((byte)(i | 0xE0));
    this.stream.write((byte)paramInt);
    this.stream.write((byte)(paramInt >>> 8));
  }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\bond\CompactBinaryWriter.class
