  ...
  extends AbstractHandler
{
  ...
  void writeQueueToDisk()
  {
    try
    {
      ...
      this.logger.info("AndroidCll-NormalEventHandler", "Writing " + ((List)localObject1).size() + " events to disk");
      localObject1 = ((List)localObject1).iterator();
      while (((Iterator)localObject1).hasNext())
      {
        localTuple = (Tuple)((Iterator)localObject1).next();
        if (ensureCanAdd(localTuple, EventEnums.Persistence.PersistenceNormal)) {
          break label147;
        }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\microsoft\cll\android\NormalEventHandler.class
