...
public class LoginManager
{
  ...
  public static void setSuccessResult(Intent paramIntent, Bundle paramBundle)
  {
    ...
    paramIntent.putExtra("com.facebook.LoginFragment:Result", LoginClient.Result.createTokenResult(localRequest, LoginMethodHandler.createAccessTokenFromWebBundle(localRequest.getPermissions(), paramBundle, AccessTokenSource.CUSTOM_TAB, localRequest.getApplicationId())));
  }
  ...
  boolean onActivityResult(int paramInt, Intent paramIntent, FacebookCallback<LoginResult> paramFacebookCallback)
  {
    ...
    if (paramIntent != null)
    {
      ...
      if (localResult != null)
      {
        localObject3 = localResult.request;
        ...
        localObject1 = localResult.token;
        bool1 = bool2;
        paramIntent = (Intent)localObject5;
        localObject4 = localResult.loggingExtras;
    ...
    for (;;)
    {
      ...
      return true;
      label188:
      paramIntent = new FacebookAuthorizationException(localResult.errorMessage);
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\facebook\login\LoginManager.class
