  ...
  public static boolean hasCustomTabRedirectActivity(Context paramContext)
  {
    ...
    if (paramContext != null)
    {
      ...
      while (paramContext.hasNext()) {
        if (((ResolveInfo)paramContext.next()).activityInfo.name.equals(CustomTabActivity.class.getName())) {
          bool1 = true;
        } else {
          return false;
        }
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\facebook\internal\Validate.class
