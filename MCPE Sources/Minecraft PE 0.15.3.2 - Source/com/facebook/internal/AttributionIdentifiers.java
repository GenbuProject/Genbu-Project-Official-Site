      ...
      try
      {
        ...
        for (;;)
        {
          ...
          if (str != null)
          {
            localObject1 = localObject5;
            localObject2 = localObject4;
            localAttributionIdentifiers.androidInstallerPackage = str;
          }
        ...
        localObject1 = localObject3;
        localObject2 = localObject3;
        int k = ((Cursor)localObject3).getColumnIndex("limit_tracking");
        localObject1 = localObject3;
        localObject2 = localObject3;
        localAttributionIdentifiers.attributionId = ((Cursor)localObject3).getString(i);
        if ((j > 0) && (k > 0))
        {
          localObject1 = localObject3;
          localObject2 = localObject3;
          if (localAttributionIdentifiers.getAndroidAdvertiserId() == null)
          {
            ...
            localObject1 = localObject3;
            localObject2 = localObject3;
            localAttributionIdentifiers.limitTracking = Boolean.parseBoolean(((Cursor)localObject3).getString(k));
          }
        }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\facebook\internal\AttributionIdentifiers.class
