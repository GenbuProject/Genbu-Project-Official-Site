  ...
  extends FragmentActivity
{
  ...
  private void handlePassThroughUrl(String paramString)
  {
    ...
    if ((paramString != null) && (paramString.startsWith(getRedirectUrl())))
    {
      ...
      if ((!(this.singleFragment instanceof LoginFragment)) || (!((LoginFragment)this.singleFragment).validateChallengeParam(localBundle))) {
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\facebook\FacebookActivity.class
