...
public class VideoUploader
{
    ...
    extends VideoUploader.UploadWorkItemBase
  {
    ...
    public Bundle getParameters()
    {
      ...
      if (this.uploadContext.params != null) {
        localBundle.putAll(this.uploadContext.params);
      }
  ...
  private static class UploadContext
  {
    ...
    private UploadContext(ShareVideoContent paramShareVideoContent, String paramString, FacebookCallback<Sharer.Result> paramFacebookCallback)
    {
      ...
      this.params = paramShareVideoContent.getVideo().getParameters();
      if (!Utility.isNullOrEmpty(paramShareVideoContent.getPeopleIds())) {
        this.params.putString("tags", TextUtils.join(", ", paramShareVideoContent.getPeopleIds()));
      }
      if (!Utility.isNullOrEmpty(paramShareVideoContent.getPlaceId())) {
        this.params.putString("place", paramShareVideoContent.getPlaceId());
      }
      if (!Utility.isNullOrEmpty(paramShareVideoContent.getRef())) {
        this.params.putString("ref", paramShareVideoContent.getRef());
      }
    }
      ...
      throws FileNotFoundException
    {
      try
      {
        ...
        {
          ParcelFileDescriptor localParcelFileDescriptor = ParcelFileDescriptor.open(new File(this.videoUri.getPath()), 268435456);
          this.videoSize = localParcelFileDescriptor.getStatSize();
          this.videoStream = new ParcelFileDescriptor.AutoCloseInputStream(localParcelFileDescriptor);
          return;
        }
    ...
    implements Runnable
  {
    ...
    {
      paramBundle = new GraphRequest(this.uploadContext.accessToken, String.format(Locale.ROOT, "%s/videos", new Object[] { this.uploadContext.graphNode }), paramBundle, HttpMethod.POST, null).executeAndWait();
      if (paramBundle != null)
      {
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\facebook\share\internal\VideoUploader.class
