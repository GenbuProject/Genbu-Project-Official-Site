...
public class AppLinkData
{
  ...
  public static AppLinkData createFromAlApplinkData(Intent paramIntent)
  {
    ...
    for (;;)
    {
      ...
      localAppLinkData.argumentBundle = ((Bundle)localObject);
      ...
      if (localObject != null)
      {
        ...
        if (localObject != null) {
          try
          {
            ...
            {
              localAppLinkData.promotionCode = ((JSONObject)localObject).getString("promo_code");
  ...
  private static AppLinkData createFromJson(String paramString)
  {
    ...
    try
    {
      ...
      if ((localJSONObject.getJSONObject("bridge_args").getString("method").equals("applink")) && (paramString.equals("2")))
      {
        ...
        if (paramString.arguments.has("extras"))
        {
          localJSONObject = paramString.arguments.getJSONObject("extras");
          if (localJSONObject.has("deeplink_context"))
          {
            ...
            if (localJSONObject.has("promo_code")) {
              paramString.promotionCode = localJSONObject.getString("promo_code");
            }
          }
        }
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\facebook\applinks\AppLinkData.class
