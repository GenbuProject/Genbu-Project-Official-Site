...
public final class FacebookSdk
{
  ...
  public static void sdkInitialize(Context paramContext, InitializeCallback paramInitializeCallback)
  {
    ...
    //   106: dup
    //   107: aload_1
    //   108: invokespecial 581	com/facebook/FacebookSdk$3:<init>	(Lcom/facebook/FacebookSdk$InitializeCallback;)V
    //   111: invokespecial 582	java/util/concurrent/FutureTask:<init>	(Ljava/util/concurrent/Callable;)V
    //   114: astore_0
    //   115: invokestatic 522	com/facebook/FacebookSdk:getExecutor	()Ljava/util/concurrent/Executor;
    //   118: aload_0
    //   119: invokeinterface 530 2 0
    //   124: goto -102 -> 22
    //   127: astore_0
    //   128: ldc 2
    //   130: monitorexit
    ...
    //   0	133	1	paramInitializeCallback	InitializeCallback
    // Exception table:
    //   from	to	target	type
    //   3	12	127	finally
    //   16	22	127	finally
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\facebook\FacebookSdk.class
