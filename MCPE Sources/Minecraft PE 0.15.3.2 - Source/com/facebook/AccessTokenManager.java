        ...
        for (;;)
        {
          try
          {
            ...
            if (localRefreshResult.accessToken != null)
            {
              ...
              localDate = new Date(localRefreshResult.expiresAt * 1000L);
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\facebook\AccessTokenManager.class
