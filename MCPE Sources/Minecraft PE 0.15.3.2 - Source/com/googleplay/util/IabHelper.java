...
public class IabHelper
{
  ...
  public boolean handleActivityResult(int paramInt1, int paramInt2, Intent paramIntent)
  {
    ...
    //   0: iload_1
    //   1: aload_0
    //   2: getfield 411	com/googleplay/util/IabHelper:mRequestCode	I
    //   5: if_icmpeq +5 -> 10
    //   8: iconst_0
    //   9: ireturn
    //   10: aload_0
    //   11: invokespecial 224	com/googleplay/util/IabHelper:checkNotDisposed	()V
    //   14: aload_0
    //   15: ldc_w 412
    //   18: invokevirtual 227	com/googleplay/util/IabHelper:checkSetupDone	(Ljava/lang/String;)V
    //   21: aload_0
    //   22: invokevirtual 414	com/googleplay/util/IabHelper:flagEndAsync	()V
    //   25: aload_3
    //   26: ifnonnull +44 -> 70
    //   29: aload_0
    //   30: ldc_w 416
    //   33: invokevirtual 214	com/googleplay/util/IabHelper:logError	(Ljava/lang/String;)V
    //   36: new 418	com/googleplay/util/IabResult
    //   39: dup
    //   40: sipush 64534
    //   43: ldc_w 420
    //   46: invokespecial 421	com/googleplay/util/IabResult:<init>	(ILjava/lang/String;)V
    //   49: astore_3
    //   50: aload_0
    //   51: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   54: ifnull +14 -> 68
    //   57: aload_0
    //   58: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   61: aload_3
    //   62: aconst_null
    ...
    //   70: aload_0
    //   71: aload_3
    //   72: invokevirtual 427	com/googleplay/util/IabHelper:getResponseCodeFromIntent	(Landroid/content/Intent;)I
    //   75: istore_1
    //   76: aload_3
    //   77: ldc 99
    ...
    //   101: aload_0
    //   102: ldc_w 433
    //   105: invokevirtual 166	com/googleplay/util/IabHelper:logDebug	(Ljava/lang/String;)V
    //   108: aload_0
    ...
    //   130: invokevirtual 166	com/googleplay/util/IabHelper:logDebug	(Ljava/lang/String;)V
    //   133: aload_0
    ...
    //   155: invokevirtual 166	com/googleplay/util/IabHelper:logDebug	(Ljava/lang/String;)V
    //   158: aload_0
    ...
    //   182: invokevirtual 166	com/googleplay/util/IabHelper:logDebug	(Ljava/lang/String;)V
    //   185: aload_0
    ...
    //   199: aload_0
    //   200: getfield 443	com/googleplay/util/IabHelper:mPurchasingItemType	Ljava/lang/String;
    ...
    //   209: invokevirtual 166	com/googleplay/util/IabHelper:logDebug	(Ljava/lang/String;)V
    //   212: aload 4
    //   214: ifnull +8 -> 222
    //   217: aload 5
    ...
    //   222: aload_0
    //   223: ldc_w 445
    //   226: invokevirtual 214	com/googleplay/util/IabHelper:logError	(Ljava/lang/String;)V
    //   229: aload_0
    ...
    //   256: invokevirtual 166	com/googleplay/util/IabHelper:logDebug	(Ljava/lang/String;)V
    //   259: new 418	com/googleplay/util/IabResult
    //   262: dup
    //   263: sipush 64528
    //   266: ldc_w 448
    //   269: invokespecial 421	com/googleplay/util/IabResult:<init>	(ILjava/lang/String;)V
    //   272: astore_3
    //   273: aload_0
    //   274: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   277: ifnull +14 -> 291
    //   280: aload_0
    //   281: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   284: aload_3
    //   285: aconst_null
    //   286: invokeinterface 425 3 0
    //   291: iconst_1
    //   292: ireturn
    //   293: new 229	com/googleplay/util/Purchase
    //   296: dup
    //   297: aload_0
    //   298: getfield 443	com/googleplay/util/IabHelper:mPurchasingItemType	Ljava/lang/String;
    //   301: aload 4
    //   303: aload 5
    //   305: invokespecial 451	com/googleplay/util/Purchase:<init>	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    //   308: astore_3
    //   309: aload_3
    //   310: invokevirtual 249	com/googleplay/util/Purchase:getSku	()Ljava/lang/String;
    //   313: astore 6
    //   315: aload_0
    //   316: getfield 152	com/googleplay/util/IabHelper:mSignatureBase64	Ljava/lang/String;
    //   319: aload 4
    //   321: aload 5
    //   323: invokestatic 457	com/googleplay/util/Security:verifyPurchase	(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Z
    //   326: ifne +83 -> 409
    //   329: aload_0
    ...
    //   351: invokevirtual 214	com/googleplay/util/IabHelper:logError	(Ljava/lang/String;)V
    //   354: new 418	com/googleplay/util/IabResult
    //   357: dup
    //   358: sipush 64533
    ...
    //   382: invokespecial 421	com/googleplay/util/IabResult:<init>	(ILjava/lang/String;)V
    //   385: astore 4
    //   387: aload_0
    //   388: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   391: ifnull +311 -> 702
    //   394: aload_0
    //   395: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   398: aload 4
    //   400: aload_3
    ...
    //   409: aload_0
    //   410: ldc_w 463
    //   413: invokevirtual 166	com/googleplay/util/IabHelper:logDebug	(Ljava/lang/String;)V
    //   416: aload_0
    //   417: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   420: ifnull +24 -> 444
    //   423: aload_0
    //   424: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   427: new 418	com/googleplay/util/IabResult
    //   430: dup
    //   431: iconst_0
    //   432: ldc_w 465
    //   435: invokespecial 421	com/googleplay/util/IabResult:<init>	(ILjava/lang/String;)V
    //   438: aload_3
    ...
    //   447: aload_0
    //   448: ldc_w 467
    //   451: invokevirtual 214	com/googleplay/util/IabHelper:logError	(Ljava/lang/String;)V
    //   454: aload_3
    //   455: invokevirtual 470	org/json/JSONException:printStackTrace	()V
    //   458: new 418	com/googleplay/util/IabResult
    //   461: dup
    //   462: sipush 64534
    //   465: ldc_w 467
    //   468: invokespecial 421	com/googleplay/util/IabResult:<init>	(ILjava/lang/String;)V
    //   471: astore_3
    //   472: aload_0
    //   473: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   476: ifnull +14 -> 490
    //   479: aload_0
    //   480: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   483: aload_3
    //   484: aconst_null
    ...
    //   511: iload_1
    //   512: invokestatic 288	com/googleplay/util/IabHelper:getResponseDesc	(I)Ljava/lang/String;
    ...
    //   521: invokevirtual 166	com/googleplay/util/IabHelper:logDebug	(Ljava/lang/String;)V
    //   524: aload_0
    //   525: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   528: ifnull -84 -> 444
    //   531: new 418	com/googleplay/util/IabResult
    //   534: dup
    //   535: iload_1
    //   536: ldc_w 474
    //   539: invokespecial 421	com/googleplay/util/IabResult:<init>	(ILjava/lang/String;)V
    //   542: astore_3
    //   543: aload_0
    //   544: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   547: aload_3
    //   548: aconst_null
    ...
    //   575: iload_1
    //   576: invokestatic 288	com/googleplay/util/IabHelper:getResponseDesc	(I)Ljava/lang/String;
    ...
    //   585: invokevirtual 166	com/googleplay/util/IabHelper:logDebug	(Ljava/lang/String;)V
    //   588: new 418	com/googleplay/util/IabResult
    //   591: dup
    //   592: sipush 64531
    //   595: ldc_w 478
    //   598: invokespecial 421	com/googleplay/util/IabResult:<init>	(ILjava/lang/String;)V
    //   601: astore_3
    //   602: aload_0
    //   603: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   606: ifnull -162 -> 444
    //   609: aload_0
    //   610: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   613: aload_3
    //   614: aconst_null
    ...
    //   650: iload_1
    //   651: invokestatic 288	com/googleplay/util/IabHelper:getResponseDesc	(I)Ljava/lang/String;
    ...
    //   660: invokevirtual 214	com/googleplay/util/IabHelper:logError	(Ljava/lang/String;)V
    //   663: new 418	com/googleplay/util/IabResult
    //   666: dup
    //   667: sipush 64530
    //   670: ldc_w 486
    //   673: invokespecial 421	com/googleplay/util/IabResult:<init>	(ILjava/lang/String;)V
    //   676: astore_3
    //   677: aload_0
    //   678: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   681: ifnull -237 -> 444
    //   684: aload_0
    //   685: getfield 339	com/googleplay/util/IabHelper:mPurchaseListener	Lcom/googleplay/util/IabHelper$OnIabPurchaseFinishedListener;
    //   688: aload_3
    //   689: aconst_null
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\Minecraft PE 0.15.3.2.jar!\com\googleplay\util\IabHelper.class
