  ...
  public static void installIfNeededAsync(Context paramContext, final ProviderInstallListener paramProviderInstallListener)
  {
    ...
    new AsyncTask()
    {
      ...
      protected void zze(Integer paramAnonymousInteger)
      {
        ...
        Intent localIntent = ProviderInstaller.zzFE().zza(this.zzxh, paramAnonymousInteger.intValue(), "pi");
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\google\android\gms\security\ProviderInstaller.class
