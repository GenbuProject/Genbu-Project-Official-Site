  ...
  implements zzau
{
  ...
  private SQLiteDatabase zzgb(String paramString)
  {
    try
    {
      SQLiteDatabase localSQLiteDatabase = this.zzbjE.getWritableDatabase();
  ...
  int zzGS()
  {
    ...
    //   3: aload_0
    //   4: ldc -89
    //   6: invokespecial 171	com/google/android/gms/tagmanager/zzby:zzgb	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   9: astore_3
    //   10: aload_3
    //   11: ifnonnull +5 -> 16
    //   14: iconst_0
    ...
    //   38: aconst_null
    //   39: aconst_null
    //   40: invokevirtual 292	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   43: astore_3
    //   44: aload_3
    //   45: invokeinterface 295 1 0
    //   50: istore_2
    //   51: iload_2
    //   52: istore_1
    //   53: aload_3
    ...
    //   69: astore_3
    //   70: ldc_w 297
    //   73: invokestatic 203	com/google/android/gms/tagmanager/zzbg:zzaK	(Ljava/lang/String;)V
    //   76: aload_3
    //   77: ifnull +56 -> 133
    //   80: aload_3
  ...
  int zzjN()
  {
    ...
    int i = ((SQLiteDatabase)localObject).delete("gtm_hits", "HIT_TIME < ?", new String[] { Long.toString(this.zzqW.currentTimeMillis() - 2592000000L) });
    Object localObject = this.zzbjG;
    if (zzGR() == 0) {}
    for (;;)
    {
  ...
  /* Error */
  List<String> zzkl(int paramInt)
  {
    // Byte code:
    //   0: new 349	java/util/ArrayList
    //   3: dup
    //   4: invokespecial 350	java/util/ArrayList:<init>	()V
    //   7: astore 6
    //   9: iload_1
    //   10: ifgt +12 -> 22
    //   13: ldc_w 352
    //   16: invokestatic 203	com/google/android/gms/tagmanager/zzbg:zzaK	(Ljava/lang/String;)V
    //   19: aload 6
    //   21: areturn
    //   22: aload_0
    //   23: ldc_w 354
    //   26: invokespecial 171	com/google/android/gms/tagmanager/zzby:zzgb	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   29: astore_3
    //   30: aload_3
    //   31: ifnonnull +6 -> 37
    //   34: aload 6
    ...
    //   52: astore 4
    //   54: iload_1
    //   55: invokestatic 359	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   58: astore 5
    //   60: aload_3
    //   61: ldc 35
    //   63: iconst_1
    ...
    //   76: aload 4
    //   78: aload 5
    //   80: invokevirtual 362	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   83: astore 4
    //   85: aload 4
    //   87: astore_3
    //   88: aload 4
    ...
    //   103: aload 4
    //   105: iconst_0
    //   106: invokeinterface 281 2 0
    //   111: invokestatic 189	java/lang/String:valueOf	(J)Ljava/lang/String;
    //   114: invokeinterface 366 2 0
    //   119: pop
    //   120: aload 4
    //   122: astore_3
    //   123: aload 4
    //   125: invokeinterface 369 1 0
    //   130: istore_2
    //   131: iload_2
    //   132: ifne -34 -> 98
    //   135: aload 4
    ...
    //   171: aload 5
    //   173: invokevirtual 374	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   176: invokevirtual 118	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   179: invokevirtual 132	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   182: invokestatic 203	com/google/android/gms/tagmanager/zzbg:zzaK	(Ljava/lang/String;)V
    //   185: aload 4
    //   187: ifnull -40 -> 147
    //   190: aload 4
  ...
  /* Error */
  public List<zzaq> zzkm(int paramInt)
  {
    // Byte code:
    //   0: new 349	java/util/ArrayList
    //   3: dup
    ...
    //   9: aload_0
    //   10: ldc_w 378
    //   13: invokespecial 171	com/google/android/gms/tagmanager/zzby:zzgb	(Ljava/lang/String;)Landroid/database/sqlite/SQLiteDatabase;
    //   16: astore 8
    //   18: aload 8
    //   20: ifnonnull +10 -> 30
    //   23: aload 5
    ...
    //   48: astore 6
    //   50: iload_1
    //   51: invokestatic 359	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   54: astore 7
    //   56: aload 8
    //   58: ldc 35
    //   60: iconst_3
    ...
    //   83: aload 6
    //   85: aload 7
    //   87: invokevirtual 362	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   90: astore 6
    //   92: aload 6
    //   94: astore 4
    //   96: new 349	java/util/ArrayList
    //   99: dup
    //   100: invokespecial 350	java/util/ArrayList:<init>	()V
    //   103: astore 7
    //   105: aload 4
    //   107: invokeinterface 277 1 0
    //   112: ifeq +54 -> 166
    //   115: aload 7
    //   117: new 380	com/google/android/gms/tagmanager/zzaq
    //   120: dup
    //   121: aload 4
    //   123: iconst_0
    ...
    //   129: aload 4
    //   131: iconst_1
    //   132: invokeinterface 281 2 0
    //   137: aload 4
    //   139: iconst_2
    //   140: invokeinterface 281 2 0
    //   145: invokespecial 383	com/google/android/gms/tagmanager/zzaq:<init>	(JJJ)V
    //   148: invokeinterface 366 2 0
    //   153: pop
    //   154: aload 4
    //   156: invokeinterface 369 1 0
    //   161: istore_3
    //   162: iload_3
    //   163: ifne -48 -> 115
    //   166: aload 4
    ...
    //   201: astore 5
    //   203: iload_1
    //   204: invokestatic 359	java/lang/Integer:toString	(I)Ljava/lang/String;
    //   207: astore 9
    //   209: aload 4
    //   211: astore 5
    //   213: aload 8
    ...
    //   235: aload 6
    //   237: aload 9
    //   239: invokevirtual 362	android/database/sqlite/SQLiteDatabase:query	(Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   242: astore 6
    //   244: aload 6
    //   246: invokeinterface 277 1 0
    //   251: ifeq +53 -> 304
    //   254: iconst_0
    //   255: istore_1
    //   256: aload 6
    //   258: checkcast 385	android/database/sqlite/SQLiteCursor
    //   261: invokevirtual 389	android/database/sqlite/SQLiteCursor:getWindow	()Landroid/database/CursorWindow;
    //   264: invokevirtual 394	android/database/CursorWindow:getNumRows	()I
    //   267: ifle +136 -> 403
    //   270: aload 7
    //   272: iload_1
    //   273: invokeinterface 398 2 0
    //   278: checkcast 380	com/google/android/gms/tagmanager/zzaq
    //   281: aload 6
    //   283: iconst_1
    //   284: invokeinterface 401 2 0
    //   289: invokevirtual 404	com/google/android/gms/tagmanager/zzaq:zzgf	(Ljava/lang/String;)V
    //   292: aload 6
    //   294: invokeinterface 369 1 0
    //   299: istore_3
    //   300: iload_3
    //   301: ifne +375 -> 676
    //   304: aload 6
    ...
    //   328: aload 7
    //   330: astore 5
    //   332: new 111	java/lang/StringBuilder
    //   335: dup
    //   336: invokespecial 112	java/lang/StringBuilder:<init>	()V
    //   339: ldc_w 371
    //   342: invokevirtual 118	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   345: aload 6
    //   347: invokevirtual 374	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    //   350: invokevirtual 118	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   353: invokevirtual 132	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   356: invokestatic 203	com/google/android/gms/tagmanager/zzbg:zzaK	(Ljava/lang/String;)V
    //   359: aload 4
    //   361: astore 6
    //   363: aload 5
    //   365: ifnull -338 -> 27
    //   368: aload 5
    //   370: invokeinterface 284 1 0
    //   375: aload 4
    //   377: areturn
    //   378: astore 6
    //   380: aload 4
    ...
    //   412: aload 7
    //   414: iload_1
    //   415: invokeinterface 398 2 0
    //   420: checkcast 380	com/google/android/gms/tagmanager/zzaq
    //   423: invokevirtual 409	com/google/android/gms/tagmanager/zzaq:zzGD	()J
    //   426: invokestatic 180	java/lang/Long:valueOf	(J)Ljava/lang/Long;
    //   429: aastore
    //   430: invokestatic 49	java/lang/String:format	(Ljava/lang/String;[Ljava/lang/Object;)Ljava/lang/String;
    //   433: invokestatic 203	com/google/android/gms/tagmanager/zzbg:zzaK	(Ljava/lang/String;)V
    //   436: goto -144 -> 292
    //   439: astore 5
    //   441: aload 6
    //   443: astore 4
    ...
    //   449: aload 4
    //   451: astore 5
    //   453: new 111	java/lang/StringBuilder
    //   456: dup
    //   457: invokespecial 112	java/lang/StringBuilder:<init>	()V
    //   460: ldc_w 411
    //   463: invokevirtual 118	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   466: aload 6
    //   468: invokevirtual 374	android/database/sqlite/SQLiteException:getMessage	()Ljava/lang/String;
    ...
    //   477: invokestatic 203	com/google/android/gms/tagmanager/zzbg:zzaK	(Ljava/lang/String;)V
    //   480: aload 4
    //   482: astore 5
    //   484: new 349	java/util/ArrayList
    //   487: dup
    //   488: invokespecial 350	java/util/ArrayList:<init>	()V
    //   491: astore 6
    //   493: iconst_0
    //   494: istore_1
    //   495: aload 4
    //   497: astore 5
    //   499: aload 7
    //   501: invokeinterface 415 1 0
    //   506: astore 7
    //   508: aload 4
    //   510: astore 5
    //   512: aload 7
    //   514: invokeinterface 420 1 0
    //   519: ifeq +42 -> 561
    //   522: aload 4
    //   524: astore 5
    //   526: aload 7
    //   528: invokeinterface 424 1 0
    //   533: checkcast 380	com/google/android/gms/tagmanager/zzaq
    //   536: astore 8
    //   538: aload 4
    //   540: astore 5
    //   542: aload 8
    //   544: invokevirtual 427	com/google/android/gms/tagmanager/zzaq:zzGF	()Ljava/lang/String;
    //   547: invokestatic 430	android/text/TextUtils:isEmpty	(Ljava/lang/CharSequence;)Z
    //   550: istore_3
    //   551: iload_1
    //   552: istore_2
    //   553: iload_3
    ...
    implements zzcx.zza
  {
    ...
    {
      zzby.zza(zzby.this, paramzzaq.zzGD());
    }
    ...
    public void zzc(zzaq paramzzaq)
    {
      ...
      if (l == 0L) {
        zzby.zza(zzby.this, paramzzaq.zzGD(), zzby.zza(zzby.this).currentTimeMillis());
      }
    ...
    extends SQLiteOpenHelper
  {
    ...
    private boolean zza(String paramString, SQLiteDatabase paramSQLiteDatabase)
    {
      ...
      //   73: invokestatic 71	com/google/android/gms/tagmanager/zzbg:zzaK	(Ljava/lang/String;)V
      //   76: aload_2
      //   77: ifnull +9 -> 86
      //   80: aload_2
    ...
    {
      if ((this.zzbjL) && (this.zzbjM + 3600000L > zzby.zza(zzby.this).currentTimeMillis())) {
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\google\android\gms\tagmanager\zzby.class
