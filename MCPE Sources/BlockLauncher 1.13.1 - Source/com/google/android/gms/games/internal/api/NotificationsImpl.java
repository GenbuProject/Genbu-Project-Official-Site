  ...
  implements Notifications
{
  public void clear(GoogleApiClient paramGoogleApiClient, int paramInt)
  {
    ...
    if (paramGoogleApiClient != null) {
      paramGoogleApiClient.zzgt(paramInt);
    }
  }
  ...
  {
    public Notifications.ContactSettingLoadResult zzaq(final Status paramStatus)
    {
  ...
  {
    public Notifications.InboxCountResult zzar(final Status paramStatus)
    {
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\google\android\gms\games\internal\api\NotificationsImpl.class
