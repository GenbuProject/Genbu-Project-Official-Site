...
public final class PlayerColumnNames
{
  ...
  public PlayerColumnNames(String paramString)
  {
    ...
    this.zzaIs = (paramString + "external_player_id");
    this.zzaIt = (paramString + "profile_name");
    this.zzaIu = (paramString + "profile_icon_image_uri");
    this.zzaIv = (paramString + "profile_icon_image_url");
    this.zzaIw = (paramString + "profile_hi_res_image_uri");
    this.zzaIx = (paramString + "profile_hi_res_image_url");
    this.zzaIy = (paramString + "last_updated");
    this.zzaIz = (paramString + "is_in_circles");
    this.zzaIA = (paramString + "played_with_timestamp");
    this.zzaIB = (paramString + "current_xp_total");
    this.zzaIC = (paramString + "current_level");
    this.zzaID = (paramString + "current_level_min_xp");
    this.zzaIE = (paramString + "current_level_max_xp");
    this.zzaIF = (paramString + "next_level");
    this.zzaIG = (paramString + "next_level_max_xp");
    this.zzaIH = (paramString + "last_level_up_timestamp");
    this.title = (paramString + "player_title");
    this.zzaII = (paramString + "has_all_public_acls");
    this.zzaIJ = (paramString + "is_profile_visible");
    this.zzaIK = (paramString + "most_recent_external_game_id");
    this.zzaIL = (paramString + "most_recent_game_name");
    this.zzaIM = (paramString + "most_recent_activity_timestamp");
    this.zzaIN = (paramString + "most_recent_game_icon_uri");
    this.zzaIO = (paramString + "most_recent_game_hi_res_uri");
    this.zzaIP = (paramString + "most_recent_game_featured_uri");
    this.zzaIQ = (paramString + "has_debug_access");
    this.zzaIR = (paramString + "gamer_tag");
    this.name = (paramString + "real_name");
    this.zzaIS = (paramString + "banner_image_landscape_uri");
    this.zzaIT = (paramString + "banner_image_landscape_url");
    this.zzaIU = (paramString + "banner_image_portrait_uri");
    this.zzaIV = (paramString + "banner_image_portrait_url");
  }
}


/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\google\android\gms\games\internal\player\PlayerColumnNames.class
