  ...
  implements Requests
{
  ...
  {
    public Requests.LoadRequestSummariesResult zzaz(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Requests.LoadRequestsResult>
  {
    ...
    public Requests.LoadRequestsResult zzaA(final Status paramStatus)
    {
  ...
  {
    public Requests.SendRequestResult zzaB(final Status paramStatus)
    {
    ...
    extends Games.BaseGamesApiMethodImpl<Requests.UpdateRequestsResult>
  {
    ...
    public Requests.UpdateRequestsResult zzaC(final Status paramStatus)
    {
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\google\android\gms\games\internal\api\RequestsImpl.class
