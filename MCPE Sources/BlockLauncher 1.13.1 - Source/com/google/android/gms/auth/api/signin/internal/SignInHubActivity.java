  ...
  extends FragmentActivity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    zzi.zza(this.zzXR, localLinkedList, (Map)localObject);
    this.zzXQ = new zzk(this, localLinkedList, (Map)localObject);
    if (paramBundle == null) {
      if (this.zzXS)
      {
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\google\android\gms\auth\api\signin\internal\SignInHubActivity.class
