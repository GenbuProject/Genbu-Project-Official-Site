...
public final class PlusShare
{
  ...
  public static class Builder
  {
    ...
    public Builder addStream(Uri paramUri)
    {
      ...
      this.zzbeh.add(localUri);
      this.zzbeh.add(paramUri);
      return this;
    }
    ...
    public Intent getIntent()
    {
      ...
      int i;
      boolean bool1;
      if ((this.zzbeh != null) && (this.zzbeh.size() > 1))
      {
        i = 1;
        ...
        if (this.mIntent.hasExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")) {
          zzx.zza(PlusShare.zzfD(this.mIntent.getStringExtra("com.google.android.apps.plus.CONTENT_DEEP_LINK_ID")), "The specified deep-link ID was malformed.");
        }
        if ((i == 0) && (bool3))
        {
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\google\android\gms\plus\PlusShare.class
