  ...
  public static boolean equals(Type paramType1, Type paramType2)
  {
    ...
    do
    {
      do
      {
        ...
        } while ((equal(paramType1.getOwnerType(), paramType2.getOwnerType())) && (paramType1.getRawType().equals(paramType2.getRawType())) && (Arrays.equals(paramType1.getActualTypeArguments(), paramType2.getActualTypeArguments())));
        return false;
      ...
      return false;
      if ((!(paramType1 instanceof TypeVariable)) || (!(paramType2 instanceof TypeVariable))) {
        break;
      }
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\google\gson\internal\$Gson$Types.class
