  ...
  implements Closeable
{
    ...
    throws IOException
  {
    ...
    for (;;)
    {
      if ((k == 2) && (i != 0) && ((l1 != Long.MIN_VALUE) || (j != 0))) {
        if (j != 0)
        {
          this.peekedLong = l1;
          this.pos += m;
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\google\gson\stream\JsonReader.class
