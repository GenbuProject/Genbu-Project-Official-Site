...
public class ChangeFriendshipDialogViewModel
{
  ...
  public void onChangeRelationshipCompleted()
  {
    ...
    label34:
    UTCChangeRelationship.RealNameStatus localRealNameStatus;
    label48:
    ...
    if (this.model.isCallerFollowingTarget())
    {
      ...
      localRealNameStatus = UTCChangeRelationship.RealNameStatus.EXISTINGSHARED;
    ...
    for (;;)
    {
      if (i == 0)
      {
        ...
        break label34;
        localRealNameStatus = UTCChangeRelationship.RealNameStatus.EXISTINGNOTSHARED;
        break label48;
      }
    ...
    extends NetworkAsyncTask<AsyncActionStatus>
  {
    ...
    {
      Object localObject = ProfileModel.getMeProfileModel();
      AsyncActionStatus localAsyncActionStatus;
      if (localObject != null)
      {
        localAsyncActionStatus = ((ProfileModel)localObject).addUserToFollowingList(this.forceLoad, this.followingUserXuid).getStatus();
        if (!AsyncActionStatus.getIsFail(localAsyncActionStatus))
        {
          AddFollowingUserResponseContainer.AddFollowingUserResponse localAddFollowingUserResponse = ((ProfileModel)localObject).getAddUserToFollowingResult();
          if ((localAddFollowingUserResponse != null) && (!localAddFollowingUserResponse.getAddFollowingRequestStatus()) && (localAddFollowingUserResponse.code == 1028)) {
            return AsyncActionStatus.FAIL;
          }
          ChangeFriendshipDialogViewModel.this.model.loadProfileSummary(true);
          ((ProfileModel)localObject).loadProfileSummary(true);
          localObject = ((ProfileModel)localObject).getFollowingData();
          if (localObject != null)
          {
            localObject = ((ArrayList)localObject).iterator();
            do
            ...
            } while (!((FollowersData)((Iterator)localObject).next()).xuid.equals(this.followingUserXuid));
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\xbox\xle\viewmodel\ChangeFriendshipDialogViewModel.class
