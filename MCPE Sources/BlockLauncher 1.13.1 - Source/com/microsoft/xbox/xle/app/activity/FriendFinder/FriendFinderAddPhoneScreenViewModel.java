    ...
    extends NetworkAsyncTask<AsyncResult<ShortCircuitProfileMessage.ShortCircuitProfileResponse>>
  {
    ...
    protected AsyncResult<ShortCircuitProfileMessage.ShortCircuitProfileResponse> loadDataInBackground()
    {
      try
      {
        ...
        return new AsyncResult(localShortCircuitProfileResponse, this, null);
      }
      catch (XLEException localXLEException)
      {
        for (;;)
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\xbox\xle\app\activity\FriendFinder\FriendFinderAddPhoneScreenViewModel.class
