...
public class JavaUtil
{
    ...
    if (paramArrayList != null)
    {
      ...
      if (isPositionInRange(paramArrayList, paramInt1))
      {
        ...
        if (isPositionInRange(paramArrayList, paramInt2))
        {
          ...
          while (i > paramInt2)
          {
            paramArrayList.set(i, paramArrayList.get(i - 1));
            i -= 1;
          }
  ...
  public static String pluralize(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    {
    default: 
      paramString2 = String.format(paramString3, new Object[] { Integer.valueOf(paramInt) });
    case 1: 
      return paramString2;
    }
    return paramString1;
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\xbox\toolkit\JavaUtil.class
