  ...
  extends ViewGroup
{
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    if (k == 0)
    {
      ...
      int i2 = Math.max(j - i - getPaddingRight(), 0);
      int i3 = Math.max(m - i1 - getPaddingBottom(), 0);
      this.checkBox.measure(View.MeasureSpec.makeMeasureSpec(i2, paramInt1), View.MeasureSpec.makeMeasureSpec(i3, paramInt2));
      i += this.checkBox.getMeasuredWidth();
      i2 = Math.max(j - i - getPaddingRight(), 0);
      i3 = Math.max(m - i1 - getPaddingBottom(), 0);
      ...
      paramInt1 = getPaddingRight() + (paramInt1 + i);
      paramInt2 = getPaddingBottom() + (i1 + paramInt2);
      if (k != 0) {
        break label304;
      }
      label286:
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\xbox\toolkit\ui\XLECheckBox.class
