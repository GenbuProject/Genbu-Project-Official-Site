  ...
  extends FrameLayout
{
  ...
  public ScreenLayout(Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    for (this.screenPercent = ((int)(100.0F * (paramContext.getDimensionPixelSize(XLERValueHelper.getStyleableRValue("ScreenLayout_screenDIPs"), SystemUtil.getScreenWidth()) / SystemUtil.getScreenWidth())));; this.screenPercent = paramContext.getInt(XLERValueHelper.getStyleableRValue("ScreenLayout_screenPercent"), -2))
    {
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\xbox\toolkit\ui\ScreenLayout.class
