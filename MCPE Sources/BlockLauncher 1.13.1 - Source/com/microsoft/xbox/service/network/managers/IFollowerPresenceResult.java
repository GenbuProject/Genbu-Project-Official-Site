...
public abstract interface IFollowerPresenceResult
{
  ...
  public static class FollowersPresenceResult
  {
    ...
    {
      paramInputStream = (IFollowerPresenceResult.UserPresence[])GsonUtil.deserializeJson(paramInputStream, IFollowerPresenceResult.UserPresence[].class, Date.class, new UTCDateConverterGson.UTCDateConverterJSONDeserializer());
      if (paramInputStream != null)
      {
        FollowersPresenceResult localFollowersPresenceResult = new FollowersPresenceResult();
        localFollowersPresenceResult.userPresence = new ArrayList(Arrays.asList(paramInputStream));
        return localFollowersPresenceResult;
      }
      return null;
    }
  }
