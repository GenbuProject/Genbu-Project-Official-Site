  ...
  extends Data<CommonData>
{
  ...
  {
    int i;
    if (super.memberwiseCompareDeep(paramPageAction))
    {
      i = 1;
      if (i == 0) {
        break label55;
  ...
  protected boolean memberwiseCompareQuick(PageAction paramPageAction)
  {
    ...
    label23:
    int j;
    if (super.memberwiseCompareQuick(paramPageAction))
    {
      i = 1;
      if (i == 0) {
        break label109;
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\xbox\idp\telemetry\utc\PageAction.class
