    ...
    if (paramEnumSet != null)
    {
      ...
      for (;;)
      {
        ...
        if (localSensitivity != EventEnums.Sensitivity.SensitivityUnspecified) {
          l1 = localSensitivity.id | l1;
        }
      }
    }
    long l2 = 0L;
    return paramLatency.id | l2 | paramPersistence.id;
  }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\cll\android\PartA.class
