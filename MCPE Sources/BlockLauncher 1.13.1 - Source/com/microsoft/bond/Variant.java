  ...
  implements BondSerializable, BondMirror
{
  ...
  protected boolean memberwiseCompareQuick(Variant paramVariant)
  {
    ...
    label71:
    int j;
    if (this.uint_value == paramVariant.uint_value)
    {
      i = 1;
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\bond\Variant.class
