...
public class Settings
{
  ...
  public String getSetting(String paramString)
  {
    try
    {
      String str1 = this._storage.readString(paramString, (String)this._defaultSettingsMap.get(paramString));
      String str2 = str1;
      if (str1 == null) {
        str2 = (String)this._defaultSettingsMap.get(paramString);
      }
      return str2;
    }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\onlineid\internal\configuration\Settings.class
