  ...
  implements ISerializer<ObjectType>
{
    ...
    throws IOException
  {
    ...
    while (paramMap.hasNext()) {
      localHashSet.add(deserialize((String)paramMap.next()));
    }
    return localHashSet;
  }
    ...
    throws IOException
  {
    ...
    while (paramMap.hasNext())
    {
      ...
      localHashMap.put(localEntry.getKey(), serialize(localEntry.getValue()));
    }
    return localHashMap;
  }
}
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\onlineid\internal\storage\ObjectStreamSerializer.class
