  ...
  implements IWebPropertyProvider
{
  ...
  public WebResourceResponse getAsset(String paramString)
  {
    ...
    do
    {
      ...
      {
        return null;
        str = buildLocalAssetPath(paramString);
      } while (TextUtils.isEmpty(str));
      localMimetype = Mimetype.findFromFilename(str);
    } while (localMimetype == null);
    try
    {
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\onlineid\internal\ui\BundledAssetVendor.class
