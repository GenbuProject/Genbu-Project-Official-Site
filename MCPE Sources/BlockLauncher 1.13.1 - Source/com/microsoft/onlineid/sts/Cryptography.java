  ...
  public static String encodeBase32(byte[] paramArrayOfByte)
  {
    ...
    for (;;)
    {
      ...
      for (;;)
      {
        if (j > 3)
        {
          localStringBuilder.append("ABCDEFGHIJKLMNOPQRSTUVWXYZ234567".charAt((int)(0x1F & l >>> j)));
          j -= 5;
          continue;
          bool = false;
          break;
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\onlineid\sts\Cryptography.class
