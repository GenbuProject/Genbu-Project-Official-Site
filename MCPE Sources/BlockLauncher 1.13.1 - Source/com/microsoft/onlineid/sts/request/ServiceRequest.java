  ...
  implements ISignableRequest
{
  ...
  {
    boolean bool;
    ISecurityScope localISecurityScope;
    if (getRequestedScopes().size() == 2)
    {
      ...
      do
      {
        ...
        localISecurityScope = (ISecurityScope)localIterator.next();
      } while (localISecurityScope.equals(DAToken.Scope));
    }
    for (;;)
    {
      return new ServiceResponse(getSigningSessionKey(), localISecurityScope, getClockSkewManager());
      bool = false;
      break;
      localISecurityScope = null;
    }
  }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\onlineid\sts\request\ServiceRequest.class
