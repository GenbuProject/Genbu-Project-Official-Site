...
public class FlightManager
{
  ...
  public Set<Integer> getFlights()
  {
    ...
    if (localObject != null) {
      return ((AuthenticatorUserAccount)localObject).getFlights();
    }
    return Collections.emptySet();
  }
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\onlineid\sts\FlightManager.class
