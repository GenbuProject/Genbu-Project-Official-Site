  ...
  extends Activity
{
  ...
  protected void onCreate(Bundle paramBundle)
  {
    ...
    boolean bool2 = PackageInfoHelper.isAuthenticatorApp((String)localObject);
    ...
    for (;;)
    {
      boolean bool3 = getIntent().getBooleanExtra("com.microsoft.onlineid.web_telemetry_requested", false);
      if ("com.microsoft.onlineid.internal.SIGN_UP_ACCOUNT".equals(str))
      {
        paramBundle = getSignupUri(paramBundle, bool2);
        label127:
        if (!"com.microsoft.onlineid.internal.SIGN_UP_ACCOUNT".equals(str)) {
          break label301;
        }
      ...
      {
        localObject = new WebFlowTelemetryData().setIsWebTelemetryRequested(bool3).setCallingAppPackageName((String)localObject).setCallingAppVersionName(PackageInfoHelper.getAppVersionName(getApplicationContext(), (String)localObject)).setWasPrecachingEnabled(bool1);
        paramBundle = WebFlowActivity.getFlowRequest(getApplicationContext(), paramBundle, str, bool2, (WebFlowTelemetryData)localObject).asIntent();
        ...
        break;
        paramBundle = getLoginUri(paramBundle, bool2, false);
        break label127;
      }
      label309:
...
/* Location:              C:\Users\Genbu Hase\ÉhÉLÉÖÉÅÉìÉg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\com\microsoft\onlineid\ui\AddAccountActivity.class
