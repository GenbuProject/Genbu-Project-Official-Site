  ...
  extends Extension
{
  ...
  {
    int i;
    if (super.memberwiseCompareDeep(paramapp))
    {
      i = 1;
      if (i == 0) {
        break label42;
  ...
  protected boolean memberwiseCompareQuick(app paramapp)
  {
    ...
    label23:
    int j;
    if (super.memberwiseCompareQuick(paramapp))
    {
      i = 1;
      if (i == 0) {
        break label67;
...
/* Location:              C:\Users\Genbu Hase\ƒhƒLƒ…ƒƒ“ƒg\Genbu\Tool\Programing\Jad\BlockLauncher 1.13.1.jar!\Microsoft\Telemetry\Extensions\app.class
